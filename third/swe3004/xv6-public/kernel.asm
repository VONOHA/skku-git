...
80101ec8:	68 4a 79 10 80       	push   $0x8010794a
...
80102e62:	e8 39 2b 00 00       	call   801059a0 <idtinit>
...
80102ee9:	e8 32 08 00 00       	call   80103720 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 2d 2a 00 00       	call   80105920 <tvinit>
  binit();         // buffer cache
...
80103629:	73 7d                	jae    801036a8 <allocproc+0xa8>
    if(p->state == UNUSED)
...
8010363a:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->nice = 20; // set nice value (project1)
80103641:	c6 43 7c 14          	movb   $0x14,0x7c(%ebx)
  p->pid = nextpid++;
80103645:	8d 50 01             	lea    0x1(%eax),%edx
80103648:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
8010364b:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
80103650:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103656:	e8 a5 0f 00 00       	call   80104600 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010365b:	e8 60 ee ff ff       	call   801024c0 <kalloc>
80103660:	83 c4 10             	add    $0x10,%esp
80103663:	85 c0                	test   %eax,%eax
80103665:	89 43 08             	mov    %eax,0x8(%ebx)
80103668:	74 57                	je     801036c1 <allocproc+0xc1>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010366a:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
80103670:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103673:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103678:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010367b:	c7 40 14 0f 59 10 80 	movl   $0x8010590f,0x14(%eax)
  p->context = (struct context*)sp;
80103682:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103685:	6a 14                	push   $0x14
80103687:	6a 00                	push   $0x0
80103689:	50                   	push   %eax
8010368a:	e8 c1 0f 00 00       	call   80104650 <memset>
  p->context->eip = (uint)forkret;
8010368f:	8b 43 1c             	mov    0x1c(%ebx),%eax

  return p;
80103692:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103695:	c7 40 10 d0 36 10 80 	movl   $0x801036d0,0x10(%eax)
}
8010369c:	89 d8                	mov    %ebx,%eax
8010369e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801036a1:	c9                   	leave  
801036a2:	c3                   	ret    
801036a3:	90                   	nop
...
801036b2:	e8 49 0f 00 00       	call   80104600 <release>
}
...
801036ca:	eb d0                	jmp    8010369c <allocproc+0x9c>
...
801037ad:	68 fc 77 10 80       	push   $0x801077fc
...
80103823:	e8 b8 36 00 00       	call   80106ee0 <setupkvm>
...
80103841:	e8 7a 33 00 00       	call   80106bc0 <inituvm>
...
801038b5:	e8 76 0f 00 00       	call   80104830 <safestrcpy>
  p->cwd = namei("/");
...
8010392c:	e8 7f 31 00 00       	call   80106ab0 <switchuvm>
  return 0;
...
8010394a:	e8 b1 33 00 00       	call   80106d00 <allocuvm>
...
8010396a:	e8 c1 34 00 00       	call   80106e30 <deallocuvm>
...
801039b8:	e8 f3 35 00 00       	call   80106fb0 <copyuvm>
...
80103a31:	e8 fa 0d 00 00       	call   80104830 <safestrcpy>
  pid = np->pid;
...
80103af0:	e8 bb 2f 00 00       	call   80106ab0 <switchuvm>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 84 0d 00 00       	call   8010488b <swtch>
      switchkvm();
80103b07:	e8 84 2f 00 00       	call   80106a90 <switchkvm>
      c->proc = 0;
...
80103ba3:	e8 e3 0c 00 00       	call   8010488b <swtch>
  mycpu()->intena = intena;
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 82 2f 00 00       	call   80106e60 <freevm>
        release(&ptable.lock);
...
8010402b:	68 63 7b 10 80       	push   $0x80107b63
...
80104058:	8b 14 85 3c 78 10 80 	mov    -0x7fef87c4(,%eax,4),%edx
      state = "???";
...
801040d5:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d8:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
801040dd:	83 ec 0c             	sub    $0xc,%esp
801040e0:	68 20 2d 11 80       	push   $0x80112d20
801040e5:	e8 56 04 00 00       	call   80104540 <acquire>
801040ea:	83 c4 10             	add    $0x10,%esp
801040ed:	eb 0c                	jmp    801040fb <getnice+0x2b>
801040ef:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040f0:	83 eb 80             	sub    $0xffffff80,%ebx
801040f3:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
801040f9:	73 25                	jae    80104120 <getnice+0x50>
    if(p->pid == pid){
801040fb:	39 73 10             	cmp    %esi,0x10(%ebx)
801040fe:	75 f0                	jne    801040f0 <getnice+0x20>
    
		release(&ptable.lock);
80104100:	83 ec 0c             	sub    $0xc,%esp
80104103:	68 20 2d 11 80       	push   $0x80112d20
80104108:	e8 f3 04 00 00       	call   80104600 <release>
		return p->nice;
8010410d:	0f be 43 7c          	movsbl 0x7c(%ebx),%eax
...
80104128:	e8 d3 04 00 00       	call   80104600 <release>
  return -1;
8010412d:	83 c4 10             	add    $0x10,%esp
}
80104130:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
...
80104145:	8b 75 0c             	mov    0xc(%ebp),%esi
80104148:	8b 5d 08             	mov    0x8(%ebp),%ebx

  if(!(value<40 && value>-1))
8010414b:	83 fe 27             	cmp    $0x27,%esi
8010414e:	77 6c                	ja     801041bc <setnice+0x7c>
	  return -1;
...
80104158:	e8 e3 03 00 00       	call   80104540 <acquire>
8010415d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104160:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104165:	eb 13                	jmp    8010417a <setnice+0x3a>
80104167:	89 f6                	mov    %esi,%esi
80104169:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80104170:	83 e8 80             	sub    $0xffffff80,%eax
80104173:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104178:	73 26                	jae    801041a0 <setnice+0x60>
    if(p->pid == pid){
8010417a:	39 58 10             	cmp    %ebx,0x10(%eax)
8010417d:	75 f1                	jne    80104170 <setnice+0x30>
      p->nice = value;
		release(&ptable.lock);
8010417f:	83 ec 0c             	sub    $0xc,%esp
      p->nice = value;
80104182:	89 f2                	mov    %esi,%edx
80104184:	88 50 7c             	mov    %dl,0x7c(%eax)
		release(&ptable.lock);
80104187:	68 20 2d 11 80       	push   $0x80112d20
8010418c:	e8 6f 04 00 00       	call   80104600 <release>
      return 0;
...
801041a8:	e8 53 04 00 00       	call   80104600 <release>
  return -1;
...
801041c1:	eb d3                	jmp    80104196 <setnice+0x56>
...
801041d5:	8b 75 08             	mov    0x8(%ebp),%esi
		...
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041d8:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
	acquire(&ptable.lock);
801041dd:	83 ec 0c             	sub    $0xc,%esp
801041e0:	68 20 2d 11 80       	push   $0x80112d20
801041e5:	e8 56 03 00 00       	call   80104540 <acquire>
	if(!pid){
801041ea:	83 c4 10             	add    $0x10,%esp
801041ed:	85 f6                	test   %esi,%esi
801041ef:	75 12                	jne    80104203 <ps+0x33>
801041f1:	eb 75                	jmp    80104268 <ps+0x98>
801041f3:	90                   	nop
801041f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041f8:	83 eb 80             	sub    $0xffffff80,%ebx
801041fb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80104201:	73 4c                	jae    8010424f <ps+0x7f>
			if(pid == p->pid){
80104203:	39 73 10             	cmp    %esi,0x10(%ebx)
80104206:	75 f0                	jne    801041f8 <ps+0x28>
				cprintf("%s %s %s %s\n","name","pid","state","priority");
80104208:	83 ec 0c             	sub    $0xc,%esp
				cprintf("%s %d %s %d\n",p->name,p->pid,states[p->state],p->nice);
8010420b:	83 c3 6c             	add    $0x6c,%ebx
				cprintf("%s %s %s %s\n","name","pid","state","priority");
8010420e:	68 8d 77 10 80       	push   $0x8010778d
80104213:	68 96 77 10 80       	push   $0x80107796
80104218:	68 9c 77 10 80       	push   $0x8010779c
8010421d:	68 a0 77 10 80       	push   $0x801077a0
80104222:	68 a5 77 10 80       	push   $0x801077a5
80104227:	e8 34 c4 ff ff       	call   80100660 <cprintf>
				cprintf("%s %d %s %d\n",p->name,p->pid,states[p->state],p->nice);
8010422c:	0f be 43 10          	movsbl 0x10(%ebx),%eax
80104230:	83 c4 14             	add    $0x14,%esp
80104233:	50                   	push   %eax
80104234:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104237:	ff 34 85 24 78 10 80 	pushl  -0x7fef87dc(,%eax,4)
8010423e:	ff 73 a4             	pushl  -0x5c(%ebx)
80104241:	53                   	push   %ebx
80104242:	68 b2 77 10 80       	push   $0x801077b2
80104247:	e8 14 c4 ff ff       	call   80100660 <cprintf>
				release(&ptable.lock);
8010424c:	83 c4 20             	add    $0x20,%esp
8010424f:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
			}
		}
		release(&ptable.lock);
		return ;
...
8010425b:	5d                   	pop    %ebp
				release(&ptable.lock);
8010425c:	e9 9f 03 00 00       	jmp    80104600 <release>
80104261:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		cprintf("%s %s %s %s\n","name","pid","state","priority");
80104268:	83 ec 0c             	sub    $0xc,%esp
8010426b:	68 8d 77 10 80       	push   $0x8010778d
80104270:	68 96 77 10 80       	push   $0x80107796
80104275:	68 9c 77 10 80       	push   $0x8010779c
8010427a:	68 a0 77 10 80       	push   $0x801077a0
8010427f:	68 a5 77 10 80       	push   $0x801077a5
80104284:	e8 d7 c3 ff ff       	call   80100660 <cprintf>
80104289:	83 c4 20             	add    $0x20,%esp
8010428c:	eb 0d                	jmp    8010429b <ps+0xcb>
8010428e:	66 90                	xchg   %ax,%ax
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104290:	83 eb 80             	sub    $0xffffff80,%ebx
80104293:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80104299:	73 b4                	jae    8010424f <ps+0x7f>
			if(p->state != UNUSED)
8010429b:	8b 43 0c             	mov    0xc(%ebx),%eax
8010429e:	85 c0                	test   %eax,%eax
801042a0:	74 ee                	je     80104290 <ps+0xc0>
				cprintf("%s %d %s %d\n",p->name,p->pid, states[p->state], p->nice);
801042a2:	0f be 53 7c          	movsbl 0x7c(%ebx),%edx
801042a6:	83 ec 0c             	sub    $0xc,%esp
801042a9:	52                   	push   %edx
801042aa:	ff 34 85 24 78 10 80 	pushl  -0x7fef87dc(,%eax,4)
801042b1:	8d 43 6c             	lea    0x6c(%ebx),%eax
801042b4:	ff 73 10             	pushl  0x10(%ebx)
801042b7:	50                   	push   %eax
801042b8:	68 b2 77 10 80       	push   $0x801077b2
801042bd:	e8 9e c3 ff ff       	call   80100660 <cprintf>
801042c2:	83 c4 20             	add    $0x20,%esp
801042c5:	eb c9                	jmp    80104290 <ps+0xc0>
...
801042da:	68 54 78 10 80       	push   $0x80107854
...
801044f5:	68 5f 78 10 80       	push   $0x8010785f
801044fa:	e8 91 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 76 78 10 80       	push   $0x80107876
...
801045e7:	68 7d 78 10 80       	push   $0x8010787d
...
8010463c:	68 85 78 10 80       	push   $0x80107885
...
801048e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048ea:	e8 f1 ee ff ff       	call   801037e0 <myproc>
...
80104955:	e8 86 ee ff ff       	call   801037e0 <myproc>
...
80104963:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104966:	e8 75 ee ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801049a8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049ab:	e8 30 ee ff ff       	call   801037e0 <myproc>
...
80104a44:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a47:	e8 94 ed ff ff       	call   801037e0 <myproc>
...
80104a57:	83 fa 17             	cmp    $0x17,%edx
80104a5a:	77 1c                	ja     80104a78 <syscall+0x38>
80104a5c:	8b 14 85 c0 78 10 80 	mov    -0x7fef8740(,%eax,4),%edx
...
80104a80:	68 8d 78 10 80       	push   $0x8010788d
...
80104bd4:	68 40 79 10 80       	push   $0x80107940
...
80104bec:	68 3f 79 10 80       	push   $0x8010793f
...
80104c05:	68 33 79 10 80       	push   $0x80107933
...
80104c1a:	68 42 79 10 80       	push   $0x80107942
80104c1f:	e8 6c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c24:	83 ec 0c             	sub    $0xc,%esp
80104c27:	68 24 79 10 80       	push   $0x80107924
...
80104c64:	e8 77 eb ff ff       	call   801037e0 <myproc>
...
80104ca9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104cab:	e8 30 eb ff ff       	call   801037e0 <myproc>
...
80104df3:	78 2b                	js     80104e20 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104df5:	e8 e6 e9 ff ff       	call   801037e0 <myproc>
...
80105019:	58                   	pop    %eax
8010501a:	5a                   	pop    %edx
8010501b:	68 40 79 10 80       	push   $0x80107940
...
80105034:	68 3f 79 10 80       	push   $0x8010793f
...
8010522f:	0f 84 a6 00 00 00    	je     801052db <sys_open+0x12b>
  struct proc *curproc = myproc();
80105235:	e8 a6 e5 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105405:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105408:	e8 d3 e3 ff ff       	call   801037e0 <myproc>
...
80105607:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010560a:	e8 d1 e1 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105641:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105648:	e8 93 e1 ff ff       	call   801037e0 <myproc>
...
80105683:	5d                   	pop    %ebp
  return fork();
80105684:	e9 f7 e2 ff ff       	jmp    80103980 <fork>
...
80105693:	83 ec 08             	sub    $0x8,%esp
  exit();
80105696:	e8 65 e5 ff ff       	call   80103c00 <exit>
...
801056a3:	5d                   	pop    %ebp
  return wait();
801056a4:	e9 97 e7 ff ff       	jmp    80103e40 <wait>
...
801056bc:	e8 8f f2 ff ff       	call   80104950 <argint>
...
801056ce:	e8 bd e8 ff ff       	call   80103f90 <kill>
...
801056f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056f6:	e8 e5 e0 ff ff       	call   801037e0 <myproc>
...
80105726:	e8 d5 e1 ff ff       	call   80103900 <growproc>
...
8010579d:	e8 de e5 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
...
801057c5:	e8 36 ee ff ff       	call   80104600 <release>
      return -1;
...
801057e8:	e8 13 ee ff ff       	call   80104600 <release>
  return 0;
...
8010581e:	e8 dd ed ff ff       	call   80104600 <release>
  return xticks;
}
...
8010583c:	e8 0f f1 ff ff       	call   80104950 <argint>
80105841:	83 c4 10             	add    $0x10,%esp
80105844:	85 c0                	test   %eax,%eax
80105846:	78 18                	js     80105860 <sys_getnice+0x30>
		return -1;
	return getnice(pid);
80105848:	83 ec 0c             	sub    $0xc,%esp
8010584b:	ff 75 f4             	pushl  -0xc(%ebp)
8010584e:	e8 7d e8 ff ff       	call   801040d0 <getnice>
...
801058cc:	e8 7f f0 ff ff       	call   80104950 <argint>
801058d1:	83 c4 10             	add    $0x10,%esp
801058d4:	85 c0                	test   %eax,%eax
801058d6:	78 18                	js     801058f0 <sys_ps+0x30>
		return -1;
	ps(pid);
801058d8:	83 ec 0c             	sub    $0xc,%esp
801058db:	ff 75 f4             	pushl  -0xc(%ebp)
801058de:	e8 ed e8 ff ff       	call   801041d0 <ps>
	return 0;
...
80105937:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
8010593e:	08 00 00 8e 
80105942:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105949:	80 
8010594a:	c1 ea 10             	shr    $0x10,%edx
8010594d:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
80105954:	80 
  for(i = 0; i < 256; i++)
...
80105964:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105967:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 85 79 10 80       	push   $0x80107985
80105976:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010597b:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105981:	c1 e8 10             	shr    $0x10,%eax
80105984:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010598a:	e8 71 ea ff ff       	call   80104400 <initlock>
}
...
801059ab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059af:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
801059e2:	0f 84 f0 00 00 00    	je     80105ad8 <trap+0x108>
    if(myproc()->killed)
      exit();
    return;
  }
...
801059f0:	ff 24 85 2c 7a 10 80 	jmp    *-0x7fef85d4(,%eax,4)
...
80105a00:	e8 db dd ff ff       	call   801037e0 <myproc>
80105a05:	85 c0                	test   %eax,%eax
80105a07:	8b 5f 38             	mov    0x38(%edi),%ebx
80105a0a:	0f 84 14 02 00 00    	je     80105c24 <trap+0x254>
80105a10:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105a14:	0f 84 0a 02 00 00    	je     80105c24 <trap+0x254>
...
80105a25:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105a28:	8b 47 34             	mov    0x34(%edi),%eax
80105a2b:	8b 77 30             	mov    0x30(%edi),%esi
...
80105a46:	52                   	push   %edx
            myproc()->pid, myproc()->name, tf->trapno,
80105a47:	8b 55 e0             	mov    -0x20(%ebp),%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a4a:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105a55:	68 e8 79 10 80       	push   $0x801079e8
...
80105a6e:	e8 6d dd ff ff       	call   801037e0 <myproc>
80105a73:	85 c0                	test   %eax,%eax
80105a75:	74 1d                	je     80105a94 <trap+0xc4>
80105a77:	e8 64 dd ff ff       	call   801037e0 <myproc>
80105a7c:	8b 50 24             	mov    0x24(%eax),%edx
80105a7f:	85 d2                	test   %edx,%edx
80105a81:	74 11                	je     80105a94 <trap+0xc4>
80105a83:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105a87:	83 e0 03             	and    $0x3,%eax
80105a8a:	66 83 f8 03          	cmp    $0x3,%ax
80105a8e:	0f 84 4c 01 00 00    	je     80105be0 <trap+0x210>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105a94:	e8 47 dd ff ff       	call   801037e0 <myproc>
80105a99:	85 c0                	test   %eax,%eax
80105a9b:	74 0b                	je     80105aa8 <trap+0xd8>
80105a9d:	e8 3e dd ff ff       	call   801037e0 <myproc>
80105aa2:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105aa6:	74 68                	je     80105b10 <trap+0x140>
...
80105add:	8b 58 24             	mov    0x24(%eax),%ebx
80105ae0:	85 db                	test   %ebx,%ebx
80105ae2:	0f 85 e8 00 00 00    	jne    80105bd0 <trap+0x200>
    myproc()->tf = tf;
80105ae8:	e8 f3 dc ff ff       	call   801037e0 <myproc>
80105aed:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105af0:	e8 4b ef ff ff       	call   80104a40 <syscall>
    if(myproc()->killed)
80105af5:	e8 e6 dc ff ff       	call   801037e0 <myproc>
80105afa:	8b 48 24             	mov    0x24(%eax),%ecx
80105afd:	85 c9                	test   %ecx,%ecx
80105aff:	74 c9                	je     80105aca <trap+0xfa>
}
...
80105b07:	5d                   	pop    %ebp
      exit();
80105b08:	e9 f3 e0 ff ff       	jmp    80103c00 <exit>
80105b0d:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105b10:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80105b14:	75 92                	jne    80105aa8 <trap+0xd8>
    yield();
80105b16:	e8 15 e2 ff ff       	call   80103d30 <yield>
80105b1b:	eb 8b                	jmp    80105aa8 <trap+0xd8>
80105b1d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105b20:	e8 9b dc ff ff       	call   801037c0 <cpuid>
80105b25:	85 c0                	test   %eax,%eax
80105b27:	0f 84 c3 00 00 00    	je     80105bf0 <trap+0x220>
    lapiceoi();
80105b2d:	e8 1e cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b32:	e8 a9 dc ff ff       	call   801037e0 <myproc>
80105b37:	85 c0                	test   %eax,%eax
80105b39:	0f 85 38 ff ff ff    	jne    80105a77 <trap+0xa7>
80105b3f:	e9 50 ff ff ff       	jmp    80105a94 <trap+0xc4>
80105b44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b48:	e8 c3 ca ff ff       	call   80102610 <kbdintr>
    lapiceoi();
80105b4d:	e8 fe cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b52:	e8 89 dc ff ff       	call   801037e0 <myproc>
80105b57:	85 c0                	test   %eax,%eax
80105b59:	0f 85 18 ff ff ff    	jne    80105a77 <trap+0xa7>
80105b5f:	e9 30 ff ff ff       	jmp    80105a94 <trap+0xc4>
80105b64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b68:	e8 53 02 00 00       	call   80105dc0 <uartintr>
    lapiceoi();
80105b6d:	e8 de cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b72:	e8 69 dc ff ff       	call   801037e0 <myproc>
80105b77:	85 c0                	test   %eax,%eax
80105b79:	0f 85 f8 fe ff ff    	jne    80105a77 <trap+0xa7>
80105b7f:	e9 10 ff ff ff       	jmp    80105a94 <trap+0xc4>
80105b84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b88:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105b8c:	8b 77 38             	mov    0x38(%edi),%esi
80105b8f:	e8 2c dc ff ff       	call   801037c0 <cpuid>
80105b94:	56                   	push   %esi
80105b95:	53                   	push   %ebx
80105b96:	50                   	push   %eax
80105b97:	68 90 79 10 80       	push   $0x80107990
80105b9c:	e8 bf aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105ba1:	e8 aa cb ff ff       	call   80102750 <lapiceoi>
    break;
80105ba6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ba9:	e8 32 dc ff ff       	call   801037e0 <myproc>
80105bae:	85 c0                	test   %eax,%eax
80105bb0:	0f 85 c1 fe ff ff    	jne    80105a77 <trap+0xa7>
80105bb6:	e9 d9 fe ff ff       	jmp    80105a94 <trap+0xc4>
80105bbb:	90                   	nop
80105bbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105bc0:	e8 bb c4 ff ff       	call   80102080 <ideintr>
80105bc5:	e9 63 ff ff ff       	jmp    80105b2d <trap+0x15d>
80105bca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bd0:	e8 2b e0 ff ff       	call   80103c00 <exit>
80105bd5:	e9 0e ff ff ff       	jmp    80105ae8 <trap+0x118>
80105bda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105be0:	e8 1b e0 ff ff       	call   80103c00 <exit>
80105be5:	e9 aa fe ff ff       	jmp    80105a94 <trap+0xc4>
80105bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105bf0:	83 ec 0c             	sub    $0xc,%esp
80105bf3:	68 60 4d 11 80       	push   $0x80114d60
80105bf8:	e8 43 e9 ff ff       	call   80104540 <acquire>
      wakeup(&ticks);
80105bfd:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105c04:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105c0b:	e8 20 e3 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105c10:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105c17:	e8 e4 e9 ff ff       	call   80104600 <release>
80105c1c:	83 c4 10             	add    $0x10,%esp
80105c1f:	e9 09 ff ff ff       	jmp    80105b2d <trap+0x15d>
80105c24:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c27:	e8 94 db ff ff       	call   801037c0 <cpuid>
80105c2c:	83 ec 0c             	sub    $0xc,%esp
80105c2f:	56                   	push   %esi
80105c30:	53                   	push   %ebx
80105c31:	50                   	push   %eax
80105c32:	ff 77 30             	pushl  0x30(%edi)
80105c35:	68 b4 79 10 80       	push   $0x801079b4
80105c3a:	e8 21 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c3f:	83 c4 14             	add    $0x14,%esp
80105c42:	68 8a 79 10 80       	push   $0x8010798a
80105c47:	e8 44 a7 ff ff       	call   80100390 <panic>
...
80105d3c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d3f:	bb ac 7a 10 80       	mov    $0x80107aac,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105dd7:	6a 00                	push   $0x0
  jmp alltraps
80105dd9:	e9 19 fb ff ff       	jmp    801058f7 <alltraps>
...
80105de0:	6a 01                	push   $0x1
  jmp alltraps
80105de2:	e9 10 fb ff ff       	jmp    801058f7 <alltraps>
...
80105de9:	6a 02                	push   $0x2
  jmp alltraps
80105deb:	e9 07 fb ff ff       	jmp    801058f7 <alltraps>
...
80105df2:	6a 03                	push   $0x3
  jmp alltraps
80105df4:	e9 fe fa ff ff       	jmp    801058f7 <alltraps>
...
80105dfb:	6a 04                	push   $0x4
  jmp alltraps
80105dfd:	e9 f5 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e04:	6a 05                	push   $0x5
  jmp alltraps
80105e06:	e9 ec fa ff ff       	jmp    801058f7 <alltraps>
...
80105e0d:	6a 06                	push   $0x6
  jmp alltraps
80105e0f:	e9 e3 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e16:	6a 07                	push   $0x7
  jmp alltraps
80105e18:	e9 da fa ff ff       	jmp    801058f7 <alltraps>
...
80105e34:	6a 0b                	push   $0xb
  jmp alltraps
80105e36:	e9 bc fa ff ff       	jmp    801058f7 <alltraps>
...
80105e3b:	6a 0c                	push   $0xc
  jmp alltraps
80105e3d:	e9 b5 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e42:	6a 0d                	push   $0xd
  jmp alltraps
80105e44:	e9 ae fa ff ff       	jmp    801058f7 <alltraps>
...
80105e49:	6a 0e                	push   $0xe
  jmp alltraps
80105e4b:	e9 a7 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e5b:	6a 10                	push   $0x10
  jmp alltraps
80105e5d:	e9 95 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e74:	6a 13                	push   $0x13
  jmp alltraps
80105e76:	e9 7c fa ff ff       	jmp    801058f7 <alltraps>
...
80105e7d:	6a 14                	push   $0x14
  jmp alltraps
80105e7f:	e9 73 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e86:	6a 15                	push   $0x15
  jmp alltraps
80105e88:	e9 6a fa ff ff       	jmp    801058f7 <alltraps>
...
80105e8f:	6a 16                	push   $0x16
  jmp alltraps
80105e91:	e9 61 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e98:	6a 17                	push   $0x17
  jmp alltraps
80105e9a:	e9 58 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ea1:	6a 18                	push   $0x18
  jmp alltraps
80105ea3:	e9 4f fa ff ff       	jmp    801058f7 <alltraps>
...
80105eaa:	6a 19                	push   $0x19
  jmp alltraps
80105eac:	e9 46 fa ff ff       	jmp    801058f7 <alltraps>
...
80105eb3:	6a 1a                	push   $0x1a
  jmp alltraps
80105eb5:	e9 3d fa ff ff       	jmp    801058f7 <alltraps>
...
80105ebc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ebe:	e9 34 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ec5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ec7:	e9 2b fa ff ff       	jmp    801058f7 <alltraps>
...
80105ece:	6a 1d                	push   $0x1d
  jmp alltraps
80105ed0:	e9 22 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ed7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ed9:	e9 19 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ee0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ee2:	e9 10 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ee9:	6a 20                	push   $0x20
  jmp alltraps
80105eeb:	e9 07 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ef2:	6a 21                	push   $0x21
  jmp alltraps
80105ef4:	e9 fe f9 ff ff       	jmp    801058f7 <alltraps>
...
80105efb:	6a 22                	push   $0x22
  jmp alltraps
80105efd:	e9 f5 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f04:	6a 23                	push   $0x23
  jmp alltraps
80105f06:	e9 ec f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f0d:	6a 24                	push   $0x24
  jmp alltraps
80105f0f:	e9 e3 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f16:	6a 25                	push   $0x25
  jmp alltraps
80105f18:	e9 da f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f1f:	6a 26                	push   $0x26
  jmp alltraps
80105f21:	e9 d1 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f28:	6a 27                	push   $0x27
  jmp alltraps
80105f2a:	e9 c8 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f31:	6a 28                	push   $0x28
  jmp alltraps
80105f33:	e9 bf f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f3a:	6a 29                	push   $0x29
  jmp alltraps
80105f3c:	e9 b6 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f43:	6a 2a                	push   $0x2a
  jmp alltraps
80105f45:	e9 ad f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f4c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f4e:	e9 a4 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f55:	6a 2c                	push   $0x2c
  jmp alltraps
80105f57:	e9 9b f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f5e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f60:	e9 92 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f67:	6a 2e                	push   $0x2e
  jmp alltraps
80105f69:	e9 89 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f70:	6a 2f                	push   $0x2f
  jmp alltraps
80105f72:	e9 80 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f79:	6a 30                	push   $0x30
  jmp alltraps
80105f7b:	e9 77 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f82:	6a 31                	push   $0x31
  jmp alltraps
80105f84:	e9 6e f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f8b:	6a 32                	push   $0x32
  jmp alltraps
80105f8d:	e9 65 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f94:	6a 33                	push   $0x33
  jmp alltraps
80105f96:	e9 5c f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f9d:	6a 34                	push   $0x34
  jmp alltraps
80105f9f:	e9 53 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fa6:	6a 35                	push   $0x35
  jmp alltraps
80105fa8:	e9 4a f9 ff ff       	jmp    801058f7 <alltraps>
...
80105faf:	6a 36                	push   $0x36
  jmp alltraps
80105fb1:	e9 41 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fb8:	6a 37                	push   $0x37
  jmp alltraps
80105fba:	e9 38 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fc1:	6a 38                	push   $0x38
  jmp alltraps
80105fc3:	e9 2f f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fca:	6a 39                	push   $0x39
  jmp alltraps
80105fcc:	e9 26 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fd3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fd5:	e9 1d f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fdc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fde:	e9 14 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fe5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fe7:	e9 0b f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fee:	6a 3d                	push   $0x3d
  jmp alltraps
80105ff0:	e9 02 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105ff7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ff9:	e9 f9 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106000:	6a 3f                	push   $0x3f
  jmp alltraps
80106002:	e9 f0 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106009:	6a 40                	push   $0x40
  jmp alltraps
8010600b:	e9 e7 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106012:	6a 41                	push   $0x41
  jmp alltraps
80106014:	e9 de f8 ff ff       	jmp    801058f7 <alltraps>
...
8010601b:	6a 42                	push   $0x42
  jmp alltraps
8010601d:	e9 d5 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106024:	6a 43                	push   $0x43
  jmp alltraps
80106026:	e9 cc f8 ff ff       	jmp    801058f7 <alltraps>
...
8010602d:	6a 44                	push   $0x44
  jmp alltraps
8010602f:	e9 c3 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106036:	6a 45                	push   $0x45
  jmp alltraps
80106038:	e9 ba f8 ff ff       	jmp    801058f7 <alltraps>
...
8010603f:	6a 46                	push   $0x46
  jmp alltraps
80106041:	e9 b1 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106048:	6a 47                	push   $0x47
  jmp alltraps
8010604a:	e9 a8 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106051:	6a 48                	push   $0x48
  jmp alltraps
80106053:	e9 9f f8 ff ff       	jmp    801058f7 <alltraps>
...
8010605a:	6a 49                	push   $0x49
  jmp alltraps
8010605c:	e9 96 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106063:	6a 4a                	push   $0x4a
  jmp alltraps
80106065:	e9 8d f8 ff ff       	jmp    801058f7 <alltraps>
...
8010606c:	6a 4b                	push   $0x4b
  jmp alltraps
8010606e:	e9 84 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106075:	6a 4c                	push   $0x4c
  jmp alltraps
80106077:	e9 7b f8 ff ff       	jmp    801058f7 <alltraps>
...
8010607e:	6a 4d                	push   $0x4d
  jmp alltraps
80106080:	e9 72 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106087:	6a 4e                	push   $0x4e
  jmp alltraps
80106089:	e9 69 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106090:	6a 4f                	push   $0x4f
  jmp alltraps
80106092:	e9 60 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106099:	6a 50                	push   $0x50
  jmp alltraps
8010609b:	e9 57 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060a2:	6a 51                	push   $0x51
  jmp alltraps
801060a4:	e9 4e f8 ff ff       	jmp    801058f7 <alltraps>
...
801060ab:	6a 52                	push   $0x52
  jmp alltraps
801060ad:	e9 45 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060b4:	6a 53                	push   $0x53
  jmp alltraps
801060b6:	e9 3c f8 ff ff       	jmp    801058f7 <alltraps>
...
801060bd:	6a 54                	push   $0x54
  jmp alltraps
801060bf:	e9 33 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060c6:	6a 55                	push   $0x55
  jmp alltraps
801060c8:	e9 2a f8 ff ff       	jmp    801058f7 <alltraps>
...
801060cf:	6a 56                	push   $0x56
  jmp alltraps
801060d1:	e9 21 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060d8:	6a 57                	push   $0x57
  jmp alltraps
801060da:	e9 18 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060e1:	6a 58                	push   $0x58
  jmp alltraps
801060e3:	e9 0f f8 ff ff       	jmp    801058f7 <alltraps>
...
801060ea:	6a 59                	push   $0x59
  jmp alltraps
801060ec:	e9 06 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060f3:	6a 5a                	push   $0x5a
  jmp alltraps
801060f5:	e9 fd f7 ff ff       	jmp    801058f7 <alltraps>
...
801060fc:	6a 5b                	push   $0x5b
  jmp alltraps
801060fe:	e9 f4 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106105:	6a 5c                	push   $0x5c
  jmp alltraps
80106107:	e9 eb f7 ff ff       	jmp    801058f7 <alltraps>
...
8010610e:	6a 5d                	push   $0x5d
  jmp alltraps
80106110:	e9 e2 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106117:	6a 5e                	push   $0x5e
  jmp alltraps
80106119:	e9 d9 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106120:	6a 5f                	push   $0x5f
  jmp alltraps
80106122:	e9 d0 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106129:	6a 60                	push   $0x60
  jmp alltraps
8010612b:	e9 c7 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106132:	6a 61                	push   $0x61
  jmp alltraps
80106134:	e9 be f7 ff ff       	jmp    801058f7 <alltraps>
...
8010613b:	6a 62                	push   $0x62
  jmp alltraps
8010613d:	e9 b5 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106144:	6a 63                	push   $0x63
  jmp alltraps
80106146:	e9 ac f7 ff ff       	jmp    801058f7 <alltraps>
...
8010614d:	6a 64                	push   $0x64
  jmp alltraps
8010614f:	e9 a3 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106156:	6a 65                	push   $0x65
  jmp alltraps
80106158:	e9 9a f7 ff ff       	jmp    801058f7 <alltraps>
...
8010615f:	6a 66                	push   $0x66
  jmp alltraps
80106161:	e9 91 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106168:	6a 67                	push   $0x67
  jmp alltraps
8010616a:	e9 88 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106171:	6a 68                	push   $0x68
  jmp alltraps
80106173:	e9 7f f7 ff ff       	jmp    801058f7 <alltraps>
...
8010617a:	6a 69                	push   $0x69
  jmp alltraps
8010617c:	e9 76 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106183:	6a 6a                	push   $0x6a
  jmp alltraps
80106185:	e9 6d f7 ff ff       	jmp    801058f7 <alltraps>
...
8010618c:	6a 6b                	push   $0x6b
  jmp alltraps
8010618e:	e9 64 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106195:	6a 6c                	push   $0x6c
  jmp alltraps
80106197:	e9 5b f7 ff ff       	jmp    801058f7 <alltraps>
...
8010619e:	6a 6d                	push   $0x6d
  jmp alltraps
801061a0:	e9 52 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061a7:	6a 6e                	push   $0x6e
  jmp alltraps
801061a9:	e9 49 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061b0:	6a 6f                	push   $0x6f
  jmp alltraps
801061b2:	e9 40 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061b9:	6a 70                	push   $0x70
  jmp alltraps
801061bb:	e9 37 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061c2:	6a 71                	push   $0x71
  jmp alltraps
801061c4:	e9 2e f7 ff ff       	jmp    801058f7 <alltraps>
...
801061cb:	6a 72                	push   $0x72
  jmp alltraps
801061cd:	e9 25 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061d4:	6a 73                	push   $0x73
  jmp alltraps
801061d6:	e9 1c f7 ff ff       	jmp    801058f7 <alltraps>
...
801061dd:	6a 74                	push   $0x74
  jmp alltraps
801061df:	e9 13 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061e6:	6a 75                	push   $0x75
  jmp alltraps
801061e8:	e9 0a f7 ff ff       	jmp    801058f7 <alltraps>
...
801061ef:	6a 76                	push   $0x76
  jmp alltraps
801061f1:	e9 01 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061f8:	6a 77                	push   $0x77
  jmp alltraps
801061fa:	e9 f8 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106201:	6a 78                	push   $0x78
  jmp alltraps
80106203:	e9 ef f6 ff ff       	jmp    801058f7 <alltraps>
...
8010620a:	6a 79                	push   $0x79
  jmp alltraps
8010620c:	e9 e6 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106213:	6a 7a                	push   $0x7a
  jmp alltraps
80106215:	e9 dd f6 ff ff       	jmp    801058f7 <alltraps>
...
8010621c:	6a 7b                	push   $0x7b
  jmp alltraps
8010621e:	e9 d4 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106225:	6a 7c                	push   $0x7c
  jmp alltraps
80106227:	e9 cb f6 ff ff       	jmp    801058f7 <alltraps>
...
8010622e:	6a 7d                	push   $0x7d
  jmp alltraps
80106230:	e9 c2 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106237:	6a 7e                	push   $0x7e
  jmp alltraps
80106239:	e9 b9 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106240:	6a 7f                	push   $0x7f
  jmp alltraps
80106242:	e9 b0 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106249:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010624e:	e9 a4 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106255:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010625a:	e9 98 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106261:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106266:	e9 8c f6 ff ff       	jmp    801058f7 <alltraps>
...
8010626d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106272:	e9 80 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106279:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010627e:	e9 74 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106285:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010628a:	e9 68 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106291:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106296:	e9 5c f6 ff ff       	jmp    801058f7 <alltraps>
...
8010629d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801062a2:	e9 50 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062a9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801062ae:	e9 44 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062b5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062ba:	e9 38 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062c1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062c6:	e9 2c f6 ff ff       	jmp    801058f7 <alltraps>
...
801062cd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062d2:	e9 20 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062d9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062de:	e9 14 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062e5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ea:	e9 08 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062f1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062f6:	e9 fc f5 ff ff       	jmp    801058f7 <alltraps>
...
801062fd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106302:	e9 f0 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106309:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010630e:	e9 e4 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106315:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010631a:	e9 d8 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106321:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106326:	e9 cc f5 ff ff       	jmp    801058f7 <alltraps>
...
8010632d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106332:	e9 c0 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106339:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010633e:	e9 b4 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106345:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010634a:	e9 a8 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106351:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106356:	e9 9c f5 ff ff       	jmp    801058f7 <alltraps>
...
8010635d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106362:	e9 90 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106369:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010636e:	e9 84 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106375:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010637a:	e9 78 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106381:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106386:	e9 6c f5 ff ff       	jmp    801058f7 <alltraps>
...
8010638d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106392:	e9 60 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106399:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010639e:	e9 54 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063a5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801063aa:	e9 48 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063b1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063b6:	e9 3c f5 ff ff       	jmp    801058f7 <alltraps>
...
801063bd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063c2:	e9 30 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063c9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063ce:	e9 24 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063d5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063da:	e9 18 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063e1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063e6:	e9 0c f5 ff ff       	jmp    801058f7 <alltraps>
...
801063ed:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063f2:	e9 00 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063f9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063fe:	e9 f4 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106405:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010640a:	e9 e8 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106411:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106416:	e9 dc f4 ff ff       	jmp    801058f7 <alltraps>
...
8010641d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106422:	e9 d0 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106429:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010642e:	e9 c4 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106435:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010643a:	e9 b8 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106441:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106446:	e9 ac f4 ff ff       	jmp    801058f7 <alltraps>
...
8010644d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106452:	e9 a0 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106459:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010645e:	e9 94 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106465:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010646a:	e9 88 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106471:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106476:	e9 7c f4 ff ff       	jmp    801058f7 <alltraps>
...
8010647d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106482:	e9 70 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106489:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010648e:	e9 64 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106495:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010649a:	e9 58 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064a1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801064a6:	e9 4c f4 ff ff       	jmp    801058f7 <alltraps>
...
801064ad:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064b2:	e9 40 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064b9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064be:	e9 34 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064c5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ca:	e9 28 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064d1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064d6:	e9 1c f4 ff ff       	jmp    801058f7 <alltraps>
...
801064dd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064e2:	e9 10 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064e9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064ee:	e9 04 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064f5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064fa:	e9 f8 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106501:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106506:	e9 ec f3 ff ff       	jmp    801058f7 <alltraps>
...
8010650d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106512:	e9 e0 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106519:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010651e:	e9 d4 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106525:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010652a:	e9 c8 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106531:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106536:	e9 bc f3 ff ff       	jmp    801058f7 <alltraps>
...
8010653d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106542:	e9 b0 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106549:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010654e:	e9 a4 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106555:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010655a:	e9 98 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106561:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106566:	e9 8c f3 ff ff       	jmp    801058f7 <alltraps>
...
8010656d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106572:	e9 80 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106579:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010657e:	e9 74 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106585:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010658a:	e9 68 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106591:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106596:	e9 5c f3 ff ff       	jmp    801058f7 <alltraps>
...
8010659d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801065a2:	e9 50 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065a9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801065ae:	e9 44 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065b5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065ba:	e9 38 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065c1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065c6:	e9 2c f3 ff ff       	jmp    801058f7 <alltraps>
...
801065cd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065d2:	e9 20 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065d9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065de:	e9 14 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065e5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ea:	e9 08 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065f1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065f6:	e9 fc f2 ff ff       	jmp    801058f7 <alltraps>
...
801065fd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106602:	e9 f0 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106609:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010660e:	e9 e4 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106615:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010661a:	e9 d8 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106621:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106626:	e9 cc f2 ff ff       	jmp    801058f7 <alltraps>
...
8010662d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106632:	e9 c0 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106639:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010663e:	e9 b4 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106645:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010664a:	e9 a8 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106651:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106656:	e9 9c f2 ff ff       	jmp    801058f7 <alltraps>
...
8010665d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106662:	e9 90 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106669:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010666e:	e9 84 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106675:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010667a:	e9 78 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106681:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106686:	e9 6c f2 ff ff       	jmp    801058f7 <alltraps>
...
8010668d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106692:	e9 60 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106699:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010669e:	e9 54 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066a5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801066aa:	e9 48 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066b1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066b6:	e9 3c f2 ff ff       	jmp    801058f7 <alltraps>
...
801066bd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066c2:	e9 30 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066c9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066ce:	e9 24 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066d5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066da:	e9 18 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066e1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066e6:	e9 0c f2 ff ff       	jmp    801058f7 <alltraps>
...
801066ed:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066f2:	e9 00 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066f9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066fe:	e9 f4 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106705:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010670a:	e9 e8 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106711:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106716:	e9 dc f1 ff ff       	jmp    801058f7 <alltraps>
...
8010671d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106722:	e9 d0 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106729:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010672e:	e9 c4 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106735:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010673a:	e9 b8 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106741:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106746:	e9 ac f1 ff ff       	jmp    801058f7 <alltraps>
...
8010674d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106752:	e9 a0 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106759:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010675e:	e9 94 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106765:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010676a:	e9 88 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106771:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106776:	e9 7c f1 ff ff       	jmp    801058f7 <alltraps>
...
8010677d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106782:	e9 70 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106789:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010678e:	e9 64 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106795:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010679a:	e9 58 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067a1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801067a6:	e9 4c f1 ff ff       	jmp    801058f7 <alltraps>
...
801067ad:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067b2:	e9 40 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067b9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067be:	e9 34 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067c5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ca:	e9 28 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067d1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067d6:	e9 1c f1 ff ff       	jmp    801058f7 <alltraps>
...
801067dd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067e2:	e9 10 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067e9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067ee:	e9 04 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067f5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067fa:	e9 f8 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106801:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106806:	e9 ec f0 ff ff       	jmp    801058f7 <alltraps>
...
8010680d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106812:	e9 e0 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106819:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010681e:	e9 d4 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106825:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010682a:	e9 c8 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106831:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106836:	e9 bc f0 ff ff       	jmp    801058f7 <alltraps>
...
8010683d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106842:	e9 b0 f0 ff ff       	jmp    801058f7 <alltraps>
...
801068aa:	e8 a1 dd ff ff       	call   80104650 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010694d:	68 b4 7a 10 80       	push   $0x80107ab4
...
80106a03:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a06:	e8 b5 cd ff ff       	call   801037c0 <cpuid>
...
80106ad4:	0f 84 c2 00 00 00    	je     80106b9c <switchuvm+0xec>
  pushcli();
80106ada:	e8 91 d9 ff ff       	call   80104470 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106adf:	e8 5c cc ff ff       	call   80103740 <mycpu>
80106ae4:	89 c6                	mov    %eax,%esi
80106ae6:	e8 55 cc ff ff       	call   80103740 <mycpu>
80106aeb:	89 c7                	mov    %eax,%edi
80106aed:	e8 4e cc ff ff       	call   80103740 <mycpu>
80106af2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106af5:	83 c7 08             	add    $0x8,%edi
80106af8:	e8 43 cc ff ff       	call   80103740 <mycpu>
...
80106bef:	e8 5c da ff ff       	call   80104650 <memset>
...
80106c20:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c21:	e9 da da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106c26:	83 ec 0c             	sub    $0xc,%esp
80106c29:	68 f9 7a 10 80       	push   $0x80107af9
...
80106d4b:	e8 00 d9 ff ff       	call   80104650 <memset>
...
80106d8d:	68 31 7b 10 80       	push   $0x80107b31
...
80106dc3:	68 49 7b 10 80       	push   $0x80107b49
...
80106ecc:	68 65 7b 10 80       	push   $0x80107b65
...
80106f6b:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f9f:	68 76 7b 10 80       	push   $0x80107b76
...
80107089:	68 9a 7b 10 80       	push   $0x80107b9a
8010708e:	e8 fd 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107093:	83 ec 0c             	sub    $0xc,%esp
80107096:	68 80 7b 10 80       	push   $0x80107b80
...
8010711f:	e8 dc d5 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
