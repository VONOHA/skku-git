...
int main(){
  ...
  11:	68 28 08 00 00       	push   $0x828
  16:	6a 01                	push   $0x1
  18:	e8 73 04 00 00       	call   490 <printf>
	printf(1,"getnice : %d\n",getnice(getpid()));
  1d:	e8 90 03 00 00       	call   3b2 <getpid>
  22:	89 04 24             	mov    %eax,(%esp)
  25:	e8 a8 03 00 00       	call   3d2 <getnice>
  2a:	83 c4 0c             	add    $0xc,%esp
  2d:	50                   	push   %eax
  2e:	68 f5 07 00 00       	push   $0x7f5
  33:	6a 01                	push   $0x1
  35:	e8 56 04 00 00       	call   490 <printf>
	printf(1, "setting nice to 24 \n");
  3a:	58                   	pop    %eax
  3b:	5a                   	pop    %edx
  3c:	68 03 08 00 00       	push   $0x803
  41:	6a 01                	push   $0x1
  43:	e8 48 04 00 00       	call   490 <printf>
	printf(1,"setnice : %s\n",setnice(getpid(),24)?"FAIL":"SUCCESS");
  48:	e8 65 03 00 00       	call   3b2 <getpid>
  4d:	59                   	pop    %ecx
  4e:	5a                   	pop    %edx
  4f:	6a 18                	push   $0x18
  51:	50                   	push   %eax
  52:	e8 83 03 00 00       	call   3da <setnice>
  57:	83 c4 0c             	add    $0xc,%esp
  5a:	ba ed 07 00 00       	mov    $0x7ed,%edx
  5f:	85 c0                	test   %eax,%eax
  61:	b8 e8 07 00 00       	mov    $0x7e8,%eax
  66:	0f 44 c2             	cmove  %edx,%eax
  69:	50                   	push   %eax
  6a:	68 18 08 00 00       	push   $0x818
  6f:	6a 01                	push   $0x1
  71:	e8 1a 04 00 00       	call   490 <printf>
	printf(1,"recalling getnice syscall \n");
  76:	59                   	pop    %ecx
  77:	58                   	pop    %eax
  78:	68 26 08 00 00       	push   $0x826
  7d:	6a 01                	push   $0x1
  7f:	e8 0c 04 00 00       	call   490 <printf>
	printf(1,"getnice : %d\n",getnice(getpid()));
  84:	e8 29 03 00 00       	call   3b2 <getpid>
  89:	89 04 24             	mov    %eax,(%esp)
  8c:	e8 41 03 00 00       	call   3d2 <getnice>
  91:	83 c4 0c             	add    $0xc,%esp
  94:	50                   	push   %eax
  95:	68 f5 07 00 00       	push   $0x7f5
  9a:	6a 01                	push   $0x1
  9c:	e8 ef 03 00 00       	call   490 <printf>
	printf(1,"calling ps syscall in current process\n");
  a1:	58                   	pop    %eax
  a2:	5a                   	pop    %edx
  a3:	68 54 08 00 00       	push   $0x854
  a8:	6a 01                	push   $0x1
  aa:	e8 e1 03 00 00       	call   490 <printf>
	ps(getpid());
  af:	e8 fe 02 00 00       	call   3b2 <getpid>
  b4:	89 04 24             	mov    %eax,(%esp)
  b7:	e8 26 03 00 00       	call   3e2 <ps>
	printf(1,"view everything\n");
  bc:	59                   	pop    %ecx
  bd:	58                   	pop    %eax
  be:	68 42 08 00 00       	push   $0x842
  c3:	6a 01                	push   $0x1
  c5:	e8 c6 03 00 00       	call   490 <printf>
	ps(0);
  ca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d1:	e8 0c 03 00 00       	call   3e2 <ps>
	exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 7c 08 00 00       	mov    $0x87c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 28 0b 00 00    	mov    0xb28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 28 0b 00 00 2c 	movl   $0xb2c,0xb28
 7b7:	0b 00 00 
 7ba:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 7c1:	0b 00 00 
    base.s.size = 0;
 7c4:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
 7c9:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 7d0:	00 00 00 
