...
main(void)
{
  ...
  52:	e8 59 04 00 00       	call   4b0 <printf>
    printf(1,"Student ID: 2022312686\nName: Lee Haesung\n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 84 08 00 00       	mov    $0x884,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 3c 0b 00 00       	mov    %eax,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 3c 0b 00 00    	cmp    %eax,0xb3c
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 ...
 7c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 7d7:	0b 00 00 
 7da:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 7e1:	0b 00 00 
    base.s.size = 0;
 7e4:	b8 40 0b 00 00       	mov    $0xb40,%eax
 7e9:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 7f0:	00 00 00 
