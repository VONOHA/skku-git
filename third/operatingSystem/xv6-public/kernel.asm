...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 c3 7d 10 80 	movl   $0x80107dc3,(%esp)
...
8010065f:	e8 2c 41 00 00       	call   80104790 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 b4 41 00 00       	call   80104850 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801007bd:	e8 ce 3f 00 00       	call   80104790 <acquire>
...
80100828:	e8 23 40 00 00       	call   80104850 <release>
...
80100877:	e8 14 3f 00 00       	call   80104790 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 7c 3e 00 00       	call   80104850 <release>
  if(doprocdump) {
...
80100a44:	e8 c7 3b 00 00       	call   80104610 <initlock>
...
80100ca3:	e8 f8 3d 00 00       	call   80104aa0 <strlen>
...
80100cb6:	e8 e5 3d 00 00       	call   80104aa0 <strlen>
...
80100d71:	e8 ea 3c 00 00       	call   80104a60 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100df4:	e8 17 38 00 00       	call   80104610 <initlock>
}
...
80100e15:	e8 76 39 00 00       	call   80104790 <acquire>
...
80100e41:	e8 0a 3a 00 00       	call   80104850 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 f1 39 00 00       	call   80104850 <release>
}
...
80100e83:	e8 08 39 00 00       	call   80104790 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 ab 39 00 00       	call   80104850 <release>
  return f;
}
...
80100ed5:	e8 b6 38 00 00       	call   80104790 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 3b 39 00 00       	call   80104850 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 0d 39 00 00       	jmp    80104850 <release>
...
80101315:	e8 86 35 00 00       	call   801048a0 <memset>
  log_write(bp);
...
8010135a:	e8 31 34 00 00       	call   80104790 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013c7:	e8 84 34 00 00       	call   80104850 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 56 34 00 00       	call   80104850 <release>
      return ip;
...
80101525:	e8 16 34 00 00       	call   80104940 <memmove>
  brelse(bp);
...
8010155a:	e8 b1 30 00 00       	call   80104610 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101577:	e8 54 2f 00 00       	call   801044d0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165e:	e8 3d 32 00 00       	call   801048a0 <memset>
      dip->type = type;
...
80101705:	e8 36 32 00 00       	call   80104940 <memmove>
  log_write(bp);
...
80101743:	e8 48 30 00 00       	call   80104790 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 f8 30 00 00       	call   80104850 <release>
}
...
80101786:	e8 85 2d 00 00       	call   80104510 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 43 31 00 00       	call   80104940 <memmove>
    brelse(bp);
...
80101857:	e8 54 2d 00 00       	call   801045b0 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 f8 2c 00 00       	jmp    80104570 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 67 2c 00 00       	call   80104510 <acquiresleep>
...
801018be:	e8 ad 2c 00 00       	call   80104570 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 c1 2e 00 00       	call   80104790 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 67 2f 00 00       	jmp    80104850 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 93 2e 00 00       	call   80104790 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 44 2f 00 00       	call   80104850 <release>
    if(r == 1){
...
80101b07:	e8 34 2e 00 00       	call   80104940 <memmove>
    brelse(bp);
...
80101c03:	e8 38 2d 00 00       	call   80104940 <memmove>
    log_write(bp);
...
80101ca2:	e8 09 2d 00 00       	call   801049b0 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 a6 2c 00 00       	call   801049b0 <strncmp>
      continue;
...
80101d9c:	e8 ef 29 00 00       	call   80104790 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 9f 2a 00 00       	call   80104850 <release>
...
80101e17:	e8 24 2b 00 00       	call   80104940 <memmove>
...
80101ea3:	e8 98 2a 00 00       	call   80104940 <memmove>
    name[len] = 0;
...
80101fd5:	e8 26 2a 00 00       	call   80104a00 <strncpy>
...
80102020:	68 aa 7b 10 80       	push   $0x80107baa
...
80102164:	e8 a7 24 00 00       	call   80104610 <initlock>
...
801021f2:	e8 99 25 00 00       	call   80104790 <acquire>
...
8010226b:	e8 e0 25 00 00       	call   80104850 <release>
...
80102292:	e8 19 23 00 00       	call   801045b0 <holdingsleep>
...
801022cc:	e8 bf 24 00 00       	call   80104790 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 15 25 00 00       	jmp    80104850 <release>
...
801024a6:	e8 f5 23 00 00       	call   801048a0 <memset>
...
801024e0:	e8 ab 22 00 00       	call   80104790 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 50 23 00 00       	jmp    80104850 <release>
    panic("kfree");
...
80102579:	e8 92 20 00 00       	call   80104610 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 28 21 00 00       	call   80104790 <acquire>
  r = kmem.freelist;
...
80102691:	e8 ba 21 00 00       	call   80104850 <release>
  return (char*)r;
...
80102abf:	e8 2c 1e 00 00       	call   801048f0 <memcmp>
...
80102bf4:	e8 47 1d 00 00       	call   80104940 <memmove>
...
80102ca8:	e8 63 19 00 00       	call   80104610 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 4c 1a 00 00       	call   80104790 <acquire>
...
80102d94:	e8 b7 1a 00 00       	call   80104850 <release>
      break;
    }
  }
}
...
80102db2:	e8 d9 19 00 00       	call   80104790 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 5b 1a 00 00       	call   80104850 <release>
}
...
80102e0a:	e8 81 19 00 00       	call   80104790 <acquire>
    wakeup(&log);
...
80102e2c:	e8 1f 1a 00 00       	call   80104850 <release>
...
80102e84:	e8 b7 1a 00 00       	call   80104940 <memmove>
...
80102ee4:	e8 67 19 00 00       	call   80104850 <release>
...
80102f52:	e8 39 18 00 00       	call   80104790 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 b6 18 00 00       	jmp    80104850 <release>
...
801030b8:	e8 83 18 00 00       	call   80104940 <memmove>
...
801031a4:	e8 47 17 00 00       	call   801048f0 <memcmp>
...
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 88 16 00 00       	call   801048f0 <memcmp>
...
8010346d:	e8 9e 11 00 00       	call   80104610 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 78 12 00 00       	call   80104790 <acquire>
  if(writable){
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 f3 12 00 00       	jmp    80104850 <release>
...
80103584:	e8 c7 12 00 00       	call   80104850 <release>
    kfree((char*)p);
...
801035b1:	e8 da 11 00 00       	call   80104790 <acquire>
  for(i = 0; i < n; i++){
...
8010363c:	e8 0f 12 00 00       	call   80104850 <release>
        return -1;
...
80103692:	e8 b9 11 00 00       	call   80104850 <release>
  return n;
...
801036ba:	e8 d1 10 00 00       	call   80104790 <acquire>
...
8010375e:	e8 ed 10 00 00       	call   80104850 <release>
  return i;
...
80103779:	e8 d2 10 00 00       	call   80104850 <release>
      return -1;
...
801037a1:	e8 ea 0f 00 00       	call   80104790 <acquire>
...
801037b9:	74 7d                	je     80103838 <allocproc+0xa8>
    if(p->state == UNUSED)
...
801037ca:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->nice = 20; // set nice value (project1)
801037d1:	c6 43 7c 14          	movb   $0x14,0x7c(%ebx)
  p->pid = nextpid++;
...
801037e0:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e6:	e8 65 10 00 00       	call   80104850 <release>
...
801037f8:	74 57                	je     80103851 <allocproc+0xc1>
    return 0;
  }
...
80103808:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380b:	c7 40 14 7f 5b 10 80 	movl   $0x80105b7f,0x14(%eax)
  p->context = (struct context*)sp;
...
8010381a:	e8 81 10 00 00       	call   801048a0 <memset>
...
8010382e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103831:	c9                   	leave  
80103832:	c3                   	ret    
...
80103842:	e8 09 10 00 00       	call   80104850 <release>
}
...
8010387f:	e8 cc 0f 00 00       	call   80104850 <release>
...
801038d4:	e8 37 0d 00 00       	call   80104610 <initlock>
}
...
8010393d:	68 40 7a 10 80       	push   $0x80107a40
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 10 0d 00 00       	call   80104690 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 50 0d 00 00       	call   801046e0 <popcli>
}
...
801039ea:	e8 b1 0e 00 00       	call   801048a0 <memset>
...
80103a49:	e8 12 10 00 00       	call   80104a60 <safestrcpy>
  p->cwd = namei("/");
...
80103aa9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aac:	e8 df 0b 00 00       	call   80104690 <pushcli>
  c = mycpu();
80103ab1:	e8 2a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 1f 0c 00 00       	call   801046e0 <popcli>
  sz = curproc->sz;
...
80103acf:	e8 2c 32 00 00       	call   80106d00 <switchuvm>
  return 0;
...
80103aea:	e8 71 34 00 00       	call   80106f60 <allocuvm>
...
80103b0a:	e8 81 35 00 00       	call   80107090 <deallocuvm>
...
80103b2a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b2d:	e8 5e 0b 00 00       	call   80104690 <pushcli>
  c = mycpu();
80103b32:	e8 a9 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b37:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b3d:	e8 9e 0b 00 00       	call   801046e0 <popcli>
  if((np = allocproc()) == 0){
...
80103b5c:	e8 af 36 00 00       	call   80107210 <copyuvm>
...
80103c76:	e8 15 0b 00 00       	call   80104790 <acquire>
...
80103c90:	e8 6b 30 00 00       	call   80106d00 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 1c 0e 00 00       	call   80104ac3 <swtch>
      switchkvm();
80103ca7:	e8 34 30 00 00       	call   80106ce0 <switchkvm>
      c->proc = 0;
...
80103ccc:	e8 7f 0b 00 00       	call   80104850 <release>
    sti();
...
80103d06:	e8 35 0a 00 00       	call   80104740 <holding>
...
80103d47:	e8 77 0d 00 00       	call   80104ac3 <swtch>
  mycpu()->intena = intena;
...
80103daa:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103dad:	e8 de 08 00 00       	call   80104690 <pushcli>
  c = mycpu();
80103db2:	e8 29 fb ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103db7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dbd:	e8 1e 09 00 00       	call   801046e0 <popcli>
  if(curproc == initproc)
...
80103e1a:	e8 71 09 00 00       	call   80104790 <acquire>
...
80103ef0:	e8 9b 08 00 00       	call   80104790 <acquire>
  pushcli();
80103ef5:	e8 96 07 00 00       	call   80104690 <pushcli>
  c = mycpu();
80103efa:	e8 e1 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103eff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f05:	e8 d6 07 00 00       	call   801046e0 <popcli>
...
80103f1d:	e8 2e 09 00 00       	call   80104850 <release>
}
...
80103f40:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f43:	e8 48 07 00 00       	call   80104690 <pushcli>
  c = mycpu();
80103f48:	e8 93 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103f4d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f53:	e8 88 07 00 00       	call   801046e0 <popcli>
  if(p == 0)
...
80103f74:	e8 17 08 00 00       	call   80104790 <acquire>
    release(lk);
...
80103f9e:	e8 ad 08 00 00       	call   80104850 <release>
    acquire(lk);
...
80103faf:	5d                   	pop    %ebp
    acquire(lk);
80103fb0:	e9 db 07 00 00       	jmp    80104790 <acquire>
...
8010408a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104091:	e8 2a 30 00 00       	call   801070c0 <freevm>
        release(&ptable.lock);
...
801040b6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040bd:	e8 8e 07 00 00       	call   80104850 <release>
        return pid;
...
801040db:	e8 70 07 00 00       	call   80104850 <release>
      return -1;
...
80104103:	e8 88 06 00 00       	call   80104790 <acquire>
...
80104148:	c9                   	leave  
  release(&ptable.lock);
80104149:	e9 02 07 00 00       	jmp    80104850 <release>
...
80104163:	e8 28 06 00 00       	call   80104790 <acquire>
...
801041a3:	e8 a8 06 00 00       	call   80104850 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c0:	e8 8b 06 00 00       	call   80104850 <release>
}
...
80104203:	68 c3 7d 10 80       	push   $0x80107dc3
...
80104230:	8b 14 85 a4 7a 10 80 	mov    -0x7fef855c(,%eax,4),%edx
      state = "???";
...
8010426d:	e8 be 03 00 00       	call   80104630 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042b9:	8b 75 08             	mov    0x8(%ebp),%esi

  struct proc *p;

  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042bc:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
801042c1:	83 ec 0c             	sub    $0xc,%esp
801042c4:	68 20 2d 11 80       	push   $0x80112d20
801042c9:	e8 c2 04 00 00       	call   80104790 <acquire>
801042ce:	83 c4 10             	add    $0x10,%esp
801042d1:	eb 10                	jmp    801042e3 <getnice+0x33>
801042d3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042d7:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042d8:	83 eb 80             	sub    $0xffffff80,%ebx
801042db:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
801042e1:	74 25                	je     80104308 <getnice+0x58>
    if(p->pid == pid){
801042e3:	39 73 10             	cmp    %esi,0x10(%ebx)
801042e6:	75 f0                	jne    801042d8 <getnice+0x28>
    
		release(&ptable.lock);
801042e8:	83 ec 0c             	sub    $0xc,%esp
801042eb:	68 20 2d 11 80       	push   $0x80112d20
801042f0:	e8 5b 05 00 00       	call   80104850 <release>
		return p->nice;
801042f5:	0f be 43 7c          	movsbl 0x7c(%ebx),%eax
...
801042fc:	8d 65 f8             	lea    -0x8(%ebp),%esp
801042ff:	5b                   	pop    %ebx
80104300:	5e                   	pop    %esi
80104301:	5d                   	pop    %ebp
80104302:	c3                   	ret    
...
80104310:	e8 3b 05 00 00       	call   80104850 <release>
  return -1;
...
8010433f:	83 fe 27             	cmp    $0x27,%esi
80104342:	77 68                	ja     801043ac <setnice+0x7c>
	  return -1;
...
8010434c:	e8 3f 04 00 00       	call   80104790 <acquire>
80104351:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104354:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104359:	eb 0f                	jmp    8010436a <setnice+0x3a>
8010435b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010435f:	90                   	nop
80104360:	83 e8 80             	sub    $0xffffff80,%eax
80104363:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104368:	74 26                	je     80104390 <setnice+0x60>
    if(p->pid == pid){
8010436a:	39 58 10             	cmp    %ebx,0x10(%eax)
8010436d:	75 f1                	jne    80104360 <setnice+0x30>
      p->nice = newNice;
		release(&ptable.lock);
8010436f:	83 ec 0c             	sub    $0xc,%esp
      p->nice = newNice;
80104372:	89 f2                	mov    %esi,%edx
80104374:	88 50 7c             	mov    %dl,0x7c(%eax)
		release(&ptable.lock);
80104377:	68 20 2d 11 80       	push   $0x80112d20
8010437c:	e8 cf 04 00 00       	call   80104850 <release>
      return 0;
...
801043b1:	eb d3                	jmp    80104386 <setnice+0x56>
...
801043c9:	8b 75 08             	mov    0x8(%ebp),%esi
		...
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043cc:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
	acquire(&ptable.lock);
801043d1:	83 ec 0c             	sub    $0xc,%esp
801043d4:	68 20 2d 11 80       	push   $0x80112d20
801043d9:	e8 b2 03 00 00       	call   80104790 <acquire>
	if(!pid){
801043de:	83 c4 10             	add    $0x10,%esp
801043e1:	85 f6                	test   %esi,%esi
801043e3:	75 16                	jne    801043fb <ps+0x3b>
801043e5:	eb 79                	jmp    80104460 <ps+0xa0>
801043e7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801043ee:	66 90                	xchg   %ax,%ax
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043f0:	83 eb 80             	sub    $0xffffff80,%ebx
801043f3:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
801043f9:	74 4c                	je     80104447 <ps+0x87>
			if(pid == p->pid){
801043fb:	39 73 10             	cmp    %esi,0x10(%ebx)
801043fe:	75 f0                	jne    801043f0 <ps+0x30>
				cprintf("%s %s %s %s\n","name","pid","state","priority");
80104400:	83 ec 0c             	sub    $0xc,%esp
				cprintf("%s %d %s %d\n",p->name,p->pid,states[p->state],p->nice);
80104403:	83 c3 6c             	add    $0x6c,%ebx
				cprintf("%s %s %s %s\n","name","pid","state","priority");
80104406:	68 d8 79 10 80       	push   $0x801079d8
8010440b:	68 e1 79 10 80       	push   $0x801079e1
80104410:	68 e7 79 10 80       	push   $0x801079e7
80104415:	68 eb 79 10 80       	push   $0x801079eb
8010441a:	68 fd 79 10 80       	push   $0x801079fd
8010441f:	e8 8c c2 ff ff       	call   801006b0 <cprintf>
				cprintf("%s %d %s %d\n",p->name,p->pid,states[p->state],p->nice);
80104424:	0f be 43 10          	movsbl 0x10(%ebx),%eax
80104428:	83 c4 14             	add    $0x14,%esp
8010442b:	50                   	push   %eax
8010442c:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010442f:	ff 34 85 8c 7a 10 80 	pushl  -0x7fef8574(,%eax,4)
80104436:	ff 73 a4             	pushl  -0x5c(%ebx)
80104439:	53                   	push   %ebx
8010443a:	68 f0 79 10 80       	push   $0x801079f0
8010443f:	e8 6c c2 ff ff       	call   801006b0 <cprintf>
				release(&ptable.lock);
80104444:	83 c4 20             	add    $0x20,%esp
80104447:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
			}
		}
		release(&ptable.lock);
		return ;
...
80104453:	5d                   	pop    %ebp
				release(&ptable.lock);
80104454:	e9 f7 03 00 00       	jmp    80104850 <release>
80104459:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		cprintf("%s       %s        %s      %s  \n","name","pid","state","priority");
80104460:	83 ec 0c             	sub    $0xc,%esp
80104463:	68 d8 79 10 80       	push   $0x801079d8
80104468:	68 e1 79 10 80       	push   $0x801079e1
8010446d:	68 e7 79 10 80       	push   $0x801079e7
80104472:	68 eb 79 10 80       	push   $0x801079eb
80104477:	68 68 7a 10 80       	push   $0x80107a68
8010447c:	e8 2f c2 ff ff       	call   801006b0 <cprintf>
80104481:	83 c4 20             	add    $0x20,%esp
80104484:	eb 15                	jmp    8010449b <ps+0xdb>
80104486:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010448d:	8d 76 00             	lea    0x0(%esi),%esi
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104490:	83 eb 80             	sub    $0xffffff80,%ebx
80104493:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80104499:	74 ac                	je     80104447 <ps+0x87>
			if(p->state != UNUSED)
8010449b:	8b 43 0c             	mov    0xc(%ebx),%eax
8010449e:	85 c0                	test   %eax,%eax
801044a0:	74 ee                	je     80104490 <ps+0xd0>
				cprintf("%s %d %s %d\n",p->name,p->pid, states[p->state], p->nice);
801044a2:	0f be 53 7c          	movsbl 0x7c(%ebx),%edx
801044a6:	83 ec 0c             	sub    $0xc,%esp
801044a9:	52                   	push   %edx
801044aa:	ff 34 85 8c 7a 10 80 	pushl  -0x7fef8574(,%eax,4)
801044b1:	8d 43 6c             	lea    0x6c(%ebx),%eax
801044b4:	ff 73 10             	pushl  0x10(%ebx)
801044b7:	50                   	push   %eax
801044b8:	68 f0 79 10 80       	push   $0x801079f0
801044bd:	e8 ee c1 ff ff       	call   801006b0 <cprintf>
801044c2:	83 c4 20             	add    $0x20,%esp
801044c5:	eb c9                	jmp    80104490 <ps+0xd0>
...
801044de:	68 bc 7a 10 80       	push   $0x80107abc
...
8010453d:	e8 ee f9 ff ff       	call   80103f30 <sleep>
  while (lk->locked) {
...
8010454b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104551:	e8 1a f4 ff ff       	call   80103970 <myproc>
...
80104598:	e8 53 fb ff ff       	call   801040f0 <wakeup>
  release(&lk->lk);
...
801045f3:	e8 78 f3 ff ff       	call   80103970 <myproc>
...
801046bf:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801046c0:	e8 1b f2 ff ff       	call   801038e0 <mycpu>
...
80104725:	68 c7 7a 10 80       	push   $0x80107ac7
8010472a:	e8 61 bc ff ff       	call   80100390 <panic>
    panic("popcli");
8010472f:	83 ec 0c             	sub    $0xc,%esp
80104732:	68 de 7a 10 80       	push   $0x80107ade
...
8010476b:	e8 70 f1 ff ff       	call   801038e0 <mycpu>
...
801047d4:	e8 07 f1 ff ff       	call   801038e0 <mycpu>
...
80104837:	68 e5 7a 10 80       	push   $0x80107ae5
...
80104890:	68 ed 7a 10 80       	push   $0x80107aed
...
80104b2b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104b2e:	e8 3d ee ff ff       	call   80103970 <myproc>
...
80104b89:	e8 e2 ed ff ff       	call   80103970 <myproc>
...
80104bdc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104bdf:	e8 8c ed ff ff       	call   80103970 <myproc>
...
80104c78:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104c7b:	e8 f0 ec ff ff       	call   80103970 <myproc>
80104c80:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104c82:	8b 40 18             	mov    0x18(%eax),%eax
80104c85:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104c88:	8d 50 ff             	lea    -0x1(%eax),%edx
80104c8b:	83 fa 17             	cmp    $0x17,%edx
80104c8e:	77 20                	ja     80104cb0 <syscall+0x40>
80104c90:	8b 14 85 20 7b 10 80 	mov    -0x7fef84e0(,%eax,4),%edx
80104c97:	85 d2                	test   %edx,%edx
80104c99:	74 15                	je     80104cb0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104c9b:	ff d2                	call   *%edx
80104c9d:	89 c2                	mov    %eax,%edx
80104c9f:	8b 43 18             	mov    0x18(%ebx),%eax
80104ca2:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104cb8:	68 f5 7a 10 80       	push   $0x80107af5
...
80104cf7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104cfa:	e8 51 d3 ff ff       	call   80102050 <nameiparent>
...
80104d1c:	e8 8f cf ff ff       	call   80101cb0 <dirlookup>
...
80104d2e:	e8 cd cc ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104d33:	89 34 24             	mov    %esi,(%esp)
80104d36:	e8 25 ca ff ff       	call   80101760 <ilock>
...
80104d64:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104d66:	e8 95 cc ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104d8a:	e8 51 c8 ff ff       	call   801015e0 <ialloc>
...
80104dc1:	e8 da c8 ff ff       	call   801016a0 <iupdate>
...
80104dd8:	e8 93 d1 ff ff       	call   80101f70 <dirlink>
...
80104de8:	e8 13 cc ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104e09:	e8 92 c8 ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104e0e:	83 c4 0c             	add    $0xc,%esp
80104e11:	ff 76 04             	pushl  0x4(%esi)
80104e14:	68 a0 7b 10 80       	push   $0x80107ba0
80104e19:	56                   	push   %esi
80104e1a:	e8 51 d1 ff ff       	call   80101f70 <dirlink>
...
80104e2c:	68 9f 7b 10 80       	push   $0x80107b9f
80104e31:	56                   	push   %esi
80104e32:	e8 39 d1 ff ff       	call   80101f70 <dirlink>
...
80104e41:	68 93 7b 10 80       	push   $0x80107b93
...
80104e5f:	68 a2 7b 10 80       	push   $0x80107ba2
80104e64:	e8 27 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104e69:	83 ec 0c             	sub    $0xc,%esp
80104e6c:	68 84 7b 10 80       	push   $0x80107b84
...
80104ea4:	e8 c7 ea ff ff       	call   80103970 <myproc>
...
80104eed:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104eef:	e8 7c ea ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104f2a:	e8 41 bf ff ff       	call   80100e70 <filedup>
  return fd;
...
80104f91:	e8 5a c0 ff ff       	call   80100ff0 <fileread>
...
80105001:	e8 8a c0 ff ff       	call   80101090 <filewrite>
...
8010504f:	e8 6c be ff ff       	call   80100ec0 <fileclose>
  return 0;
...
801050a8:	e8 f3 be ff ff       	call   80100fa0 <filestat>
...
801050f6:	0f 88 e6 00 00 00    	js     801051e2 <sys_link+0x122>
  begin_op();
801050fc:	e8 2f dc ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
80105101:	83 ec 0c             	sub    $0xc,%esp
80105104:	ff 75 d4             	pushl  -0x2c(%ebp)
80105107:	e8 24 cf ff ff       	call   80102030 <namei>
...
8010511d:	e8 3e c6 ff ff       	call   80101760 <ilock>
  if(ip->type == T_DIR){
...
8010513c:	e8 5f c5 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80105141:	89 1c 24             	mov    %ebx,(%esp)
80105144:	e8 f7 c6 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105149:	58                   	pop    %eax
8010514a:	5a                   	pop    %edx
8010514b:	57                   	push   %edi
8010514c:	ff 75 d0             	pushl  -0x30(%ebp)
8010514f:	e8 fc ce ff ff       	call   80102050 <nameiparent>
...
80105161:	e8 fa c5 ff ff       	call   80101760 <ilock>
...
80105177:	e8 f4 cd ff ff       	call   80101f70 <dirlink>
...
80105187:	e8 74 c8 ff ff       	call   80101a00 <iunlockput>
  iput(ip);
8010518c:	89 1c 24             	mov    %ebx,(%esp)
8010518f:	e8 fc c6 ff ff       	call   80101890 <iput>
  end_op();
80105194:	e8 07 dc ff ff       	call   80102da0 <end_op>
  return 0;
...
801051b4:	e8 47 c8 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801051cd:	e8 ce c4 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
801051d2:	89 1c 24             	mov    %ebx,(%esp)
801051d5:	e8 26 c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
801051ed:	e8 0e c8 ff ff       	call   80101a00 <iunlockput>
    end_op();
801051f2:	e8 a9 db ff ff       	call   80102da0 <end_op>
    return -1;
...
8010525d:	58                   	pop    %eax
8010525e:	5a                   	pop    %edx
8010525f:	68 a0 7b 10 80       	push   $0x80107ba0
80105264:	53                   	push   %ebx
80105265:	e8 26 ca ff ff       	call   80101c90 <namecmp>
...
80105278:	68 9f 7b 10 80       	push   $0x80107b9f
8010527d:	53                   	push   %ebx
8010527e:	e8 0d ca ff ff       	call   80101c90 <namecmp>
...
80105297:	e8 14 ca ff ff       	call   80101cb0 <dirlookup>
...
801052ad:	e8 ae c4 ff ff       	call   80101760 <ilock>
  if(ip->nlink < 1)
...
801052de:	e8 7d c8 ff ff       	call   80101b60 <writei>
...
801052fe:	e8 fd c6 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
80105303:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105308:	89 1c 24             	mov    %ebx,(%esp)
8010530b:	e8 90 c3 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
...
80105350:	e8 0b c7 ff ff       	call   80101a60 <readi>
...
8010536b:	e8 90 c6 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
8010537c:	e8 7f c6 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
801053b5:	e9 68 ff ff ff       	jmp    80105322 <sys_unlink+0x112>
    end_op();
801053ba:	e8 e1 d9 ff ff       	call   80102da0 <end_op>
    return -1;
...
80105426:	78 75                	js     8010549d <sys_open+0xad>
  ...
  begin_op();
80105428:	e8 03 d9 ff ff       	call   80102d30 <begin_op>
...
80105439:	e8 f2 cb ff ff       	call   80102030 <namei>
...
8010544b:	e8 10 c3 ff ff       	call   80101760 <ilock>
...
80105484:	e8 37 ba ff ff       	call   80100ec0 <fileclose>
80105489:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010548c:	83 ec 0c             	sub    $0xc,%esp
8010548f:	56                   	push   %esi
80105490:	e8 6b c5 ff ff       	call   80101a00 <iunlockput>
    end_op();
...
801054e0:	e8 5b c3 ff ff       	call   80101840 <iunlock>
  end_op();
...
80105537:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
8010553a:	e8 f1 d7 ff ff       	call   80102d30 <begin_op>
...
80105612:	e8 e9 c3 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105617:	e8 84 d7 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105649:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010564c:	e8 1f e3 ff ff       	call   80103970 <myproc>
...
80105673:	e8 b8 c9 ff ff       	call   80102030 <namei>
...
80105685:	e8 d6 c0 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
...
80105698:	e8 a3 c1 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
8010569d:	58                   	pop    %eax
8010569e:	ff 76 68             	pushl  0x68(%esi)
801056a1:	e8 ea c1 ff ff       	call   80101890 <iput>
  end_op();
801056a6:	e8 f5 d6 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
...
801056c4:	e8 37 c3 ff ff       	call   80101a00 <iunlockput>
    end_op();
801056c9:	e8 d2 d6 ff ff       	call   80102da0 <end_op>
    return -1;
...
801056df:	90                   	nop
    end_op();
801056e0:	e8 bb d6 ff ff       	call   80102da0 <end_op>
    return -1;
...
801057d3:	e8 a8 b2 ff ff       	call   80100a80 <exec>
...
8010581c:	e8 cf db ff ff       	call   801033f0 <pipealloc>
...
8010582b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010582d:	e8 3e e1 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010584e:	e8 6d b6 ff ff       	call   80100ec0 <fileclose>
    fileclose(wf);
80105853:	58                   	pop    %eax
80105854:	ff 75 e4             	pushl  -0x1c(%ebp)
80105857:	e8 64 b6 ff ff       	call   80100ec0 <fileclose>
    return -1;
...
801058d0:	f3 0f 1e fb          	endbr32 
  return fork();
801058d4:	e9 47 e2 ff ff       	jmp    80103b20 <fork>
...
801058e7:	83 ec 08             	sub    $0x8,%esp
  exit();
801058ea:	e8 b1 e4 ff ff       	call   80103da0 <exit>
...
80105900:	f3 0f 1e fb          	endbr32 
  return wait();
80105904:	e9 e7 e6 ff ff       	jmp    80103ff0 <wait>
...
80105932:	e8 19 e8 ff ff       	call   80104150 <kill>
...
8010598b:	78 23                	js     801059b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010598d:	e8 de df ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
8010599a:	e8 01 e1 ff ff       	call   80103aa0 <growproc>
...
801059e4:	68 60 4d 11 80       	push   $0x80114d60
801059e9:	e8 a2 ed ff ff       	call   80104790 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801059ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801059f1:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
80105a08:	68 a0 55 11 80       	push   $0x801155a0
80105a0d:	e8 1e e5 ff ff       	call   80103f30 <sleep>
  while(ticks - ticks0 < n){
80105a12:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
80105a30:	68 60 4d 11 80       	push   $0x80114d60
...
80105a78:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a7b:	68 60 4d 11 80       	push   $0x80114d60
80105a80:	e8 0b ed ff ff       	call   80104790 <acquire>
  xticks = ticks;
80105a85:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105a8b:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
...
80105ab0:	e8 cb f0 ff ff       	call   80104b80 <argint>
80105ab5:	83 c4 10             	add    $0x10,%esp
80105ab8:	85 c0                	test   %eax,%eax
80105aba:	78 14                	js     80105ad0 <sys_getnice+0x30>
		return -1;
	return getnice(pid);
80105abc:	83 ec 0c             	sub    $0xc,%esp
80105abf:	ff 75 f4             	pushl  -0xc(%ebp)
80105ac2:	e8 e9 e7 ff ff       	call   801042b0 <getnice>
...
80105b40:	e8 3b f0 ff ff       	call   80104b80 <argint>
80105b45:	83 c4 10             	add    $0x10,%esp
80105b48:	85 c0                	test   %eax,%eax
80105b4a:	78 14                	js     80105b60 <sys_ps+0x30>
		return -1;
	ps(pid);
80105b4c:	83 ec 0c             	sub    $0xc,%esp
80105b4f:	ff 75 f4             	pushl  -0xc(%ebp)
80105b52:	e8 69 e8 ff ff       	call   801043c0 <ps>
	return 0;
...
80105ba7:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
80105bae:	08 00 00 8e 
80105bb2:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105bb9:	80 
80105bba:	c1 ea 10             	shr    $0x10,%edx
80105bbd:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
80105bc4:	80 
  for(i = 0; i < 256; i++)
...
80105bd7:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
80105bde:	00 00 ef 
  initlock(&tickslock, "time");
80105be1:	68 e5 7b 10 80       	push   $0x80107be5
80105be6:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105beb:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105bf1:	c1 e8 10             	shr    $0x10,%eax
80105bf4:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
80105bfa:	e8 11 ea ff ff       	call   80104610 <initlock>
}
...
80105c1f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c23:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105d67:	68 60 4d 11 80       	push   $0x80114d60
80105d6c:	e8 1f ea ff ff       	call   80104790 <acquire>
      wakeup(&ticks);
80105d71:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105d78:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105d7f:	e8 6c e3 ff ff       	call   801040f0 <wakeup>
      release(&tickslock);
80105d84:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105d8b:	e8 c0 ea ff ff       	call   80104850 <release>
...
80105e04:	0f 85 0e ff ff ff    	jne    80105d18 <trap+0xd8>
    yield();
80105e0a:	e8 d1 e0 ff ff       	call   80103ee0 <yield>
...
80105e29:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e2c:	e8 3f ee ff ff       	call   80104c70 <syscall>
    if(myproc()->killed)
...
80105e47:	5d                   	pop    %ebp
      exit();
80105e48:	e9 53 df ff ff       	jmp    80103da0 <exit>
...
80105e5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105e60:	e8 3b df ff ff       	call   80103da0 <exit>
...
80105e85:	68 ea 7b 10 80       	push   $0x80107bea
...
8010601b:	6a 00                	push   $0x0
  jmp alltraps
8010601d:	e9 45 fb ff ff       	jmp    80105b67 <alltraps>
...
80106024:	6a 01                	push   $0x1
  jmp alltraps
80106026:	e9 3c fb ff ff       	jmp    80105b67 <alltraps>
...
8010602d:	6a 02                	push   $0x2
  jmp alltraps
8010602f:	e9 33 fb ff ff       	jmp    80105b67 <alltraps>
...
80106036:	6a 03                	push   $0x3
  jmp alltraps
80106038:	e9 2a fb ff ff       	jmp    80105b67 <alltraps>
...
8010603f:	6a 04                	push   $0x4
  jmp alltraps
80106041:	e9 21 fb ff ff       	jmp    80105b67 <alltraps>
...
80106048:	6a 05                	push   $0x5
  jmp alltraps
8010604a:	e9 18 fb ff ff       	jmp    80105b67 <alltraps>
...
80106051:	6a 06                	push   $0x6
  jmp alltraps
80106053:	e9 0f fb ff ff       	jmp    80105b67 <alltraps>
...
8010605a:	6a 07                	push   $0x7
  jmp alltraps
8010605c:	e9 06 fb ff ff       	jmp    80105b67 <alltraps>
...
80106061:	6a 08                	push   $0x8
  jmp alltraps
80106063:	e9 ff fa ff ff       	jmp    80105b67 <alltraps>
...
8010606a:	6a 09                	push   $0x9
  jmp alltraps
8010606c:	e9 f6 fa ff ff       	jmp    80105b67 <alltraps>
...
80106071:	6a 0a                	push   $0xa
  jmp alltraps
80106073:	e9 ef fa ff ff       	jmp    80105b67 <alltraps>
...
80106078:	6a 0b                	push   $0xb
  jmp alltraps
8010607a:	e9 e8 fa ff ff       	jmp    80105b67 <alltraps>
...
8010607f:	6a 0c                	push   $0xc
  jmp alltraps
80106081:	e9 e1 fa ff ff       	jmp    80105b67 <alltraps>
...
8010609f:	6a 10                	push   $0x10
  jmp alltraps
801060a1:	e9 c1 fa ff ff       	jmp    80105b67 <alltraps>
...
801060af:	6a 12                	push   $0x12
  jmp alltraps
801060b1:	e9 b1 fa ff ff       	jmp    80105b67 <alltraps>
...
801060b8:	6a 13                	push   $0x13
  jmp alltraps
801060ba:	e9 a8 fa ff ff       	jmp    80105b67 <alltraps>
...
801060c1:	6a 14                	push   $0x14
  jmp alltraps
801060c3:	e9 9f fa ff ff       	jmp    80105b67 <alltraps>
...
801060ca:	6a 15                	push   $0x15
  jmp alltraps
801060cc:	e9 96 fa ff ff       	jmp    80105b67 <alltraps>
...
801060d3:	6a 16                	push   $0x16
  jmp alltraps
801060d5:	e9 8d fa ff ff       	jmp    80105b67 <alltraps>
...
801060dc:	6a 17                	push   $0x17
  jmp alltraps
801060de:	e9 84 fa ff ff       	jmp    80105b67 <alltraps>
...
801060e5:	6a 18                	push   $0x18
  jmp alltraps
801060e7:	e9 7b fa ff ff       	jmp    80105b67 <alltraps>
...
801060ee:	6a 19                	push   $0x19
  jmp alltraps
801060f0:	e9 72 fa ff ff       	jmp    80105b67 <alltraps>
...
801060f7:	6a 1a                	push   $0x1a
  jmp alltraps
801060f9:	e9 69 fa ff ff       	jmp    80105b67 <alltraps>
...
80106100:	6a 1b                	push   $0x1b
  jmp alltraps
80106102:	e9 60 fa ff ff       	jmp    80105b67 <alltraps>
...
80106109:	6a 1c                	push   $0x1c
  jmp alltraps
8010610b:	e9 57 fa ff ff       	jmp    80105b67 <alltraps>
...
80106112:	6a 1d                	push   $0x1d
  jmp alltraps
80106114:	e9 4e fa ff ff       	jmp    80105b67 <alltraps>
...
8010611b:	6a 1e                	push   $0x1e
  jmp alltraps
8010611d:	e9 45 fa ff ff       	jmp    80105b67 <alltraps>
...
80106124:	6a 1f                	push   $0x1f
  jmp alltraps
80106126:	e9 3c fa ff ff       	jmp    80105b67 <alltraps>
...
8010612d:	6a 20                	push   $0x20
  jmp alltraps
8010612f:	e9 33 fa ff ff       	jmp    80105b67 <alltraps>
...
80106136:	6a 21                	push   $0x21
  jmp alltraps
80106138:	e9 2a fa ff ff       	jmp    80105b67 <alltraps>
...
8010613f:	6a 22                	push   $0x22
  jmp alltraps
80106141:	e9 21 fa ff ff       	jmp    80105b67 <alltraps>
...
80106148:	6a 23                	push   $0x23
  jmp alltraps
8010614a:	e9 18 fa ff ff       	jmp    80105b67 <alltraps>
...
80106151:	6a 24                	push   $0x24
  jmp alltraps
80106153:	e9 0f fa ff ff       	jmp    80105b67 <alltraps>
...
8010615a:	6a 25                	push   $0x25
  jmp alltraps
8010615c:	e9 06 fa ff ff       	jmp    80105b67 <alltraps>
...
80106163:	6a 26                	push   $0x26
  jmp alltraps
80106165:	e9 fd f9 ff ff       	jmp    80105b67 <alltraps>
...
8010616c:	6a 27                	push   $0x27
  jmp alltraps
8010616e:	e9 f4 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106175:	6a 28                	push   $0x28
  jmp alltraps
80106177:	e9 eb f9 ff ff       	jmp    80105b67 <alltraps>
...
8010617e:	6a 29                	push   $0x29
  jmp alltraps
80106180:	e9 e2 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106187:	6a 2a                	push   $0x2a
  jmp alltraps
80106189:	e9 d9 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106190:	6a 2b                	push   $0x2b
  jmp alltraps
80106192:	e9 d0 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106199:	6a 2c                	push   $0x2c
  jmp alltraps
8010619b:	e9 c7 f9 ff ff       	jmp    80105b67 <alltraps>
...
801061a2:	6a 2d                	push   $0x2d
  jmp alltraps
801061a4:	e9 be f9 ff ff       	jmp    80105b67 <alltraps>
...
801061ab:	6a 2e                	push   $0x2e
  jmp alltraps
801061ad:	e9 b5 f9 ff ff       	jmp    80105b67 <alltraps>
...
801061b4:	6a 2f                	push   $0x2f
  jmp alltraps
801061b6:	e9 ac f9 ff ff       	jmp    80105b67 <alltraps>
...
801061bd:	6a 30                	push   $0x30
  jmp alltraps
801061bf:	e9 a3 f9 ff ff       	jmp    80105b67 <alltraps>
...
801061c6:	6a 31                	push   $0x31
  jmp alltraps
801061c8:	e9 9a f9 ff ff       	jmp    80105b67 <alltraps>
...
801061cf:	6a 32                	push   $0x32
  jmp alltraps
801061d1:	e9 91 f9 ff ff       	jmp    80105b67 <alltraps>
...
801061d8:	6a 33                	push   $0x33
  jmp alltraps
801061da:	e9 88 f9 ff ff       	jmp    80105b67 <alltraps>
...
801061e1:	6a 34                	push   $0x34
  jmp alltraps
801061e3:	e9 7f f9 ff ff       	jmp    80105b67 <alltraps>
...
801061ea:	6a 35                	push   $0x35
  jmp alltraps
801061ec:	e9 76 f9 ff ff       	jmp    80105b67 <alltraps>
...
801061f3:	6a 36                	push   $0x36
  jmp alltraps
801061f5:	e9 6d f9 ff ff       	jmp    80105b67 <alltraps>
...
801061fc:	6a 37                	push   $0x37
  jmp alltraps
801061fe:	e9 64 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106205:	6a 38                	push   $0x38
  jmp alltraps
80106207:	e9 5b f9 ff ff       	jmp    80105b67 <alltraps>
...
8010620e:	6a 39                	push   $0x39
  jmp alltraps
80106210:	e9 52 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106217:	6a 3a                	push   $0x3a
  jmp alltraps
80106219:	e9 49 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106220:	6a 3b                	push   $0x3b
  jmp alltraps
80106222:	e9 40 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106229:	6a 3c                	push   $0x3c
  jmp alltraps
8010622b:	e9 37 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106232:	6a 3d                	push   $0x3d
  jmp alltraps
80106234:	e9 2e f9 ff ff       	jmp    80105b67 <alltraps>
...
8010623b:	6a 3e                	push   $0x3e
  jmp alltraps
8010623d:	e9 25 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106244:	6a 3f                	push   $0x3f
  jmp alltraps
80106246:	e9 1c f9 ff ff       	jmp    80105b67 <alltraps>
...
8010624d:	6a 40                	push   $0x40
  jmp alltraps
8010624f:	e9 13 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106256:	6a 41                	push   $0x41
  jmp alltraps
80106258:	e9 0a f9 ff ff       	jmp    80105b67 <alltraps>
...
8010625f:	6a 42                	push   $0x42
  jmp alltraps
80106261:	e9 01 f9 ff ff       	jmp    80105b67 <alltraps>
...
80106268:	6a 43                	push   $0x43
  jmp alltraps
8010626a:	e9 f8 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106271:	6a 44                	push   $0x44
  jmp alltraps
80106273:	e9 ef f8 ff ff       	jmp    80105b67 <alltraps>
...
8010627a:	6a 45                	push   $0x45
  jmp alltraps
8010627c:	e9 e6 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106283:	6a 46                	push   $0x46
  jmp alltraps
80106285:	e9 dd f8 ff ff       	jmp    80105b67 <alltraps>
...
8010628c:	6a 47                	push   $0x47
  jmp alltraps
8010628e:	e9 d4 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106295:	6a 48                	push   $0x48
  jmp alltraps
80106297:	e9 cb f8 ff ff       	jmp    80105b67 <alltraps>
...
8010629e:	6a 49                	push   $0x49
  jmp alltraps
801062a0:	e9 c2 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062a7:	6a 4a                	push   $0x4a
  jmp alltraps
801062a9:	e9 b9 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062b0:	6a 4b                	push   $0x4b
  jmp alltraps
801062b2:	e9 b0 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062b9:	6a 4c                	push   $0x4c
  jmp alltraps
801062bb:	e9 a7 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062c2:	6a 4d                	push   $0x4d
  jmp alltraps
801062c4:	e9 9e f8 ff ff       	jmp    80105b67 <alltraps>
...
801062cb:	6a 4e                	push   $0x4e
  jmp alltraps
801062cd:	e9 95 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062d4:	6a 4f                	push   $0x4f
  jmp alltraps
801062d6:	e9 8c f8 ff ff       	jmp    80105b67 <alltraps>
...
801062dd:	6a 50                	push   $0x50
  jmp alltraps
801062df:	e9 83 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062e6:	6a 51                	push   $0x51
  jmp alltraps
801062e8:	e9 7a f8 ff ff       	jmp    80105b67 <alltraps>
...
801062ef:	6a 52                	push   $0x52
  jmp alltraps
801062f1:	e9 71 f8 ff ff       	jmp    80105b67 <alltraps>
...
801062f8:	6a 53                	push   $0x53
  jmp alltraps
801062fa:	e9 68 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106301:	6a 54                	push   $0x54
  jmp alltraps
80106303:	e9 5f f8 ff ff       	jmp    80105b67 <alltraps>
...
8010630a:	6a 55                	push   $0x55
  jmp alltraps
8010630c:	e9 56 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106313:	6a 56                	push   $0x56
  jmp alltraps
80106315:	e9 4d f8 ff ff       	jmp    80105b67 <alltraps>
...
8010631c:	6a 57                	push   $0x57
  jmp alltraps
8010631e:	e9 44 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106325:	6a 58                	push   $0x58
  jmp alltraps
80106327:	e9 3b f8 ff ff       	jmp    80105b67 <alltraps>
...
8010632e:	6a 59                	push   $0x59
  jmp alltraps
80106330:	e9 32 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106337:	6a 5a                	push   $0x5a
  jmp alltraps
80106339:	e9 29 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106340:	6a 5b                	push   $0x5b
  jmp alltraps
80106342:	e9 20 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106349:	6a 5c                	push   $0x5c
  jmp alltraps
8010634b:	e9 17 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106352:	6a 5d                	push   $0x5d
  jmp alltraps
80106354:	e9 0e f8 ff ff       	jmp    80105b67 <alltraps>
...
8010635b:	6a 5e                	push   $0x5e
  jmp alltraps
8010635d:	e9 05 f8 ff ff       	jmp    80105b67 <alltraps>
...
80106364:	6a 5f                	push   $0x5f
  jmp alltraps
80106366:	e9 fc f7 ff ff       	jmp    80105b67 <alltraps>
...
8010636d:	6a 60                	push   $0x60
  jmp alltraps
8010636f:	e9 f3 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106376:	6a 61                	push   $0x61
  jmp alltraps
80106378:	e9 ea f7 ff ff       	jmp    80105b67 <alltraps>
...
8010637f:	6a 62                	push   $0x62
  jmp alltraps
80106381:	e9 e1 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106388:	6a 63                	push   $0x63
  jmp alltraps
8010638a:	e9 d8 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106391:	6a 64                	push   $0x64
  jmp alltraps
80106393:	e9 cf f7 ff ff       	jmp    80105b67 <alltraps>
...
8010639a:	6a 65                	push   $0x65
  jmp alltraps
8010639c:	e9 c6 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063a3:	6a 66                	push   $0x66
  jmp alltraps
801063a5:	e9 bd f7 ff ff       	jmp    80105b67 <alltraps>
...
801063ac:	6a 67                	push   $0x67
  jmp alltraps
801063ae:	e9 b4 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063b5:	6a 68                	push   $0x68
  jmp alltraps
801063b7:	e9 ab f7 ff ff       	jmp    80105b67 <alltraps>
...
801063be:	6a 69                	push   $0x69
  jmp alltraps
801063c0:	e9 a2 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063c7:	6a 6a                	push   $0x6a
  jmp alltraps
801063c9:	e9 99 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063d0:	6a 6b                	push   $0x6b
  jmp alltraps
801063d2:	e9 90 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063d9:	6a 6c                	push   $0x6c
  jmp alltraps
801063db:	e9 87 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063e2:	6a 6d                	push   $0x6d
  jmp alltraps
801063e4:	e9 7e f7 ff ff       	jmp    80105b67 <alltraps>
...
801063eb:	6a 6e                	push   $0x6e
  jmp alltraps
801063ed:	e9 75 f7 ff ff       	jmp    80105b67 <alltraps>
...
801063f4:	6a 6f                	push   $0x6f
  jmp alltraps
801063f6:	e9 6c f7 ff ff       	jmp    80105b67 <alltraps>
...
801063fd:	6a 70                	push   $0x70
  jmp alltraps
801063ff:	e9 63 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106406:	6a 71                	push   $0x71
  jmp alltraps
80106408:	e9 5a f7 ff ff       	jmp    80105b67 <alltraps>
...
8010640f:	6a 72                	push   $0x72
  jmp alltraps
80106411:	e9 51 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106418:	6a 73                	push   $0x73
  jmp alltraps
8010641a:	e9 48 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106421:	6a 74                	push   $0x74
  jmp alltraps
80106423:	e9 3f f7 ff ff       	jmp    80105b67 <alltraps>
...
8010642a:	6a 75                	push   $0x75
  jmp alltraps
8010642c:	e9 36 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106433:	6a 76                	push   $0x76
  jmp alltraps
80106435:	e9 2d f7 ff ff       	jmp    80105b67 <alltraps>
...
8010643c:	6a 77                	push   $0x77
  jmp alltraps
8010643e:	e9 24 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106445:	6a 78                	push   $0x78
  jmp alltraps
80106447:	e9 1b f7 ff ff       	jmp    80105b67 <alltraps>
...
8010644e:	6a 79                	push   $0x79
  jmp alltraps
80106450:	e9 12 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106457:	6a 7a                	push   $0x7a
  jmp alltraps
80106459:	e9 09 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106460:	6a 7b                	push   $0x7b
  jmp alltraps
80106462:	e9 00 f7 ff ff       	jmp    80105b67 <alltraps>
...
80106469:	6a 7c                	push   $0x7c
  jmp alltraps
8010646b:	e9 f7 f6 ff ff       	jmp    80105b67 <alltraps>
...
80106472:	6a 7d                	push   $0x7d
  jmp alltraps
80106474:	e9 ee f6 ff ff       	jmp    80105b67 <alltraps>
...
8010647b:	6a 7e                	push   $0x7e
  jmp alltraps
8010647d:	e9 e5 f6 ff ff       	jmp    80105b67 <alltraps>
...
80106484:	6a 7f                	push   $0x7f
  jmp alltraps
80106486:	e9 dc f6 ff ff       	jmp    80105b67 <alltraps>
...
8010648d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106492:	e9 d0 f6 ff ff       	jmp    80105b67 <alltraps>
...
801064a5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801064aa:	e9 b8 f6 ff ff       	jmp    80105b67 <alltraps>
...
801064b1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801064b6:	e9 ac f6 ff ff       	jmp    80105b67 <alltraps>
...
80106aea:	e8 b1 dd ff ff       	call   801048a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106ce4:	a1 a4 55 11 80       	mov    0x801155a4,%eax
...
80106d28:	0f 84 c2 00 00 00    	je     80106df0 <switchuvm+0xf0>
  pushcli();
80106d2e:	e8 5d d9 ff ff       	call   80104690 <pushcli>
...
80106ddd:	5d                   	pop    %ebp
  popcli();
80106dde:	e9 fd d8 ff ff       	jmp    801046e0 <popcli>
...
80106e43:	e8 58 da ff ff       	call   801048a0 <memset>
...
80106e76:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e77:	e9 c4 da ff ff       	jmp    80104940 <memmove>
...
80107164:	e8 37 d7 ff ff       	call   801048a0 <memset>
...
801071cf:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107250:	e8 eb d6 ff ff       	call   80104940 <memmove>
...
8010737e:	e8 bd d5 ff ff       	call   80104940 <memmove>
    len -= n;
    buf += n;
