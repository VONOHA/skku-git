...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb b2 08 00 00       	mov    $0x8b2,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 70 0b 00 00       	mov    0xb70,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 822:	00 00 00 
    if(p->s.size >= nunits){
