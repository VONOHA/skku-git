...
int main(){
  ...
  15:	68 58 08 00 00       	push   $0x858
  1a:	6a 01                	push   $0x1
  1c:	e8 8f 04 00 00       	call   4b0 <printf>
	printf(1,"getnice : %d\n",getnice(getpid()));
  21:	e8 9d 03 00 00       	call   3c3 <getpid>
  26:	89 04 24             	mov    %eax,(%esp)
  29:	e8 b5 03 00 00       	call   3e3 <getnice>
  2e:	83 c4 0c             	add    $0xc,%esp
  31:	50                   	push   %eax
  32:	68 25 08 00 00       	push   $0x825
  37:	6a 01                	push   $0x1
  39:	e8 72 04 00 00       	call   4b0 <printf>
	printf(1, "setting nice to 24 \n");
  3e:	58                   	pop    %eax
  3f:	5a                   	pop    %edx
  40:	68 33 08 00 00       	push   $0x833
  45:	6a 01                	push   $0x1
  47:	e8 64 04 00 00       	call   4b0 <printf>
	printf(1,"setnice : %s\n",setnice(getpid(),24)?"FAIL":"SUCCESS");
  4c:	e8 72 03 00 00       	call   3c3 <getpid>
  51:	59                   	pop    %ecx
  52:	5a                   	pop    %edx
  53:	6a 18                	push   $0x18
  55:	50                   	push   %eax
  56:	e8 90 03 00 00       	call   3eb <setnice>
  5b:	83 c4 0c             	add    $0xc,%esp
  5e:	ba 1d 08 00 00       	mov    $0x81d,%edx
  63:	85 c0                	test   %eax,%eax
  65:	b8 18 08 00 00       	mov    $0x818,%eax
  6a:	0f 44 c2             	cmove  %edx,%eax
  6d:	50                   	push   %eax
  6e:	68 48 08 00 00       	push   $0x848
  73:	6a 01                	push   $0x1
  75:	e8 36 04 00 00       	call   4b0 <printf>
	printf(1,"recalling getnice syscall \n");
  7a:	59                   	pop    %ecx
  7b:	58                   	pop    %eax
  7c:	68 56 08 00 00       	push   $0x856
  81:	6a 01                	push   $0x1
  83:	e8 28 04 00 00       	call   4b0 <printf>
	printf(1,"getnice : %d\n",getnice(getpid()));
  88:	e8 36 03 00 00       	call   3c3 <getpid>
  8d:	89 04 24             	mov    %eax,(%esp)
  90:	e8 4e 03 00 00       	call   3e3 <getnice>
  95:	83 c4 0c             	add    $0xc,%esp
  98:	50                   	push   %eax
  99:	68 25 08 00 00       	push   $0x825
  9e:	6a 01                	push   $0x1
  a0:	e8 0b 04 00 00       	call   4b0 <printf>
	printf(1,"calling ps syscall in current process\n");
  a5:	58                   	pop    %eax
  a6:	5a                   	pop    %edx
  a7:	68 84 08 00 00       	push   $0x884
  ac:	6a 01                	push   $0x1
  ae:	e8 fd 03 00 00       	call   4b0 <printf>
	ps(getpid());
  b3:	e8 0b 03 00 00       	call   3c3 <getpid>
  b8:	89 04 24             	mov    %eax,(%esp)
  bb:	e8 33 03 00 00       	call   3f3 <ps>
	printf(1,"view everything\n");
  c0:	59                   	pop    %ecx
  c1:	58                   	pop    %eax
  c2:	68 72 08 00 00       	push   $0x872
  c7:	6a 01                	push   $0x1
  c9:	e8 e2 03 00 00       	call   4b0 <printf>
	ps(0);
  ce:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d5:	e8 19 03 00 00       	call   3f3 <ps>
	exit();
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb ab 08 00 00       	mov    $0x8ab,%ebx
        while(*s != 0){
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 5c 0b 00 00       	mov    %eax,0xb5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 5c 0b 00 00       	mov    0xb5c,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 60 0b 00 00       	mov    $0xb60,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 802:	00 00 00 
    if(p->s.size >= nunits){
